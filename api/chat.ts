...
- There are FOUR pillars. ACADEMY (/academy): the course. LIBRARY: a catalogue of prompts, .md briefs and agent skills filed by category and by trade — the paid part. FRUGALITY: what a run costs in tokens, in euros and in grams of CO2e, and the levers that cut it. DOJO: the 3D room, which is now a SANDBOX for practising — open a teammate, read the prompt that makes it what it is, change it, see what changes.
