...
export const DECK_SLIDES: DeckSlide[] = [
  { n: '', eyebrow: 'Investor deck', title: 'Learn to build AI agents — and to run them cheap.', line: 'A hands-on academy for agents, prompts and AI tooling, with the frugality practices most courses skip: what a run really costs in tokens, in euros and in grams of CO₂e, and how to cut it. The course is free; the library of prompts, briefs and skills is the paid part.', obj: 'rocket', accent: A.magenta, layout: 'brand', points: ['Free course, paid library', 'Frugality nobody else teaches', 'Sold as software, not tokens'] },
