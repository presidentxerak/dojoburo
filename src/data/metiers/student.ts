...
const DEEP: Record<string, Deepening> = {
  ...
  'st-revise/st-cards': {
    intro: B("Flashcards work because they force active recall: you read a question, you search your memory, and only then you see the answer. Each successful search makes the memory stronger. AI can turn a lecture into twenty cards in a minute, but only good cards help: one idea each, a question that makes you produce the answer, and nothing that is not in your course. In this dojo you give the AI one lecture at a time, set those three rules, ask for the source line of every card, and check the cards before studying them. The result is a deck you can trust.",
      "Les fiches fonctionnent parce qu'elles forcent le rappel actif : vous lisez une question, vous cherchez dans votre mémoire, et seulement ensuite vous voyez la réponse. Chaque recherche réussie renforce le souvenir. L'IA peut transformer un cours en vingt fiches en une minute, mais seules les bonnes fiches aident : une idée chacune, une question qui oblige à produire la réponse, et rien qui soit hors du cours. Dans ce dojo, vous donnez à l'IA un cours à la fois, posez ces trois règles, demandez la ligne source de chaque fiche, et vérifiez les fiches avant de les apprendre. Vous obtenez un jeu de fiches fiable."),
    concepts: [
      { term: B('Active recall', 'Rappel actif'),
        def: B("Retrieving information from memory without looking at it. It strengthens memory more than rereading, and it is the basis of every good flashcard.",
          "Retrouver une information de mémoire sans la regarder. Il renforce le souvenir davantage que la relecture, et fonde toute bonne fiche.") },
      { term: B('Testing effect', 'Effet de test'),
        def: B("The finding that testing yourself on material improves long-term memory more than studying it again for the same time.",
          "Le constat selon lequel s'interroger sur une matière améliore la mémoire à long terme davantage que de l'étudier de nouveau pendant le même temps.") },
      { term: B('Atomic card', 'Fiche atomique'),
        def: B("A card that holds a single idea. If you miss it, you know exactly what you missed; a card with five facts hides which ones you forgot.",
          "Une fiche qui ne porte qu'une idée. Si vous la manquez, vous savez précisément quoi ; une fiche à cinq faits cache ceux que vous avez oubliés.") },
      { term: B('Source line', 'Ligne source'),
        def: B("The line of your notes that a card comes from. It lets you check each card in seconds and delete any the AI invented.",
          "La ligne de vos notes d'où vient une fiche. Elle permet de vérifier chaque fiche en quelques secondes et de supprimer celles que l'IA aurait inventées.") },
    ],
    walkthrough: {
      title: B("Samir builds a deck on the formation of contracts for his law exam",
        "Samir construit un jeu de fiches sur la formation du contrat pour son examen de droit"),
      steps: [
        B("Samir numbers the lines of his notes for one lecture, the formation of contracts, and pastes only that. One lecture keeps the cards precise; a whole semester would produce vague ones.",
          "Samir numérote les lignes de ses notes d'un seul cours, la formation du contrat, et ne colle que celles-ci. Un seul cours garde les fiches précises ; un semestre entier en produirait de vagues."),
        B("He sets the rules: one idea per card, questions that require producing the answer, a third of the cards as short cases, answers under 25 words. His exam uses cases, so his cards must too.",
          "Il pose les règles : une idée par fiche, des questions qui exigent de produire la réponse, un tiers de petits cas, des réponses de moins de 25 mots. Son examen repose sur des cas, ses fiches aussi."),
        B("He asks for the line number after each card and forbids anything outside his notes. The AI lists two topics it thought were missing, separately, as questions for him.",
          "Il demande le numéro de ligne après chaque fiche et interdit tout ce qui est extérieur à ses notes. L'IA liste à part deux sujets qui lui semblaient manquer, sous forme de questions pour lui."),
        B("He checks all 20 cards against the line numbers. One card cites a ruling his teacher never mentioned: he deletes it. Another mixes two conditions: he splits it into two cards.",
          "Il vérifie les 20 fiches grâce aux numéros de ligne. Une fiche cite un arrêt que l'enseignant n'a jamais mentionné : il la supprime. Une autre mêle deux conditions : il la divise en deux fiches."),
        B("He imports the cards into his flashcard app and studies them answer hidden, saying each answer before turning. The deck is now reliable and matched to his exam.",
          "Il importe les fiches dans son application et les travaille réponse cachée, en disant chaque réponse avant de retourner. Le jeu est désormais fiable et adapté à son examen."),
      ],
    },
    mistakes: [
      { wrong: B("Pasting a whole semester of notes at once.",
          "Coller d'un coup les notes d'un semestre entier."),
        fix: B("Work one lecture at a time. The cards stay precise, and checking twenty cards against a few pages is quick.",
          "Travaillez un cours à la fois. Les fiches restent précises, et vérifier vingt fiches sur quelques pages est rapide.") },
      { wrong: B("Keeping cards that ask for a list or offer true or false.",
          "Garder des fiches qui demandent une liste ou proposent un vrai ou faux."),
        fix: B("Split list cards into one card per item, and turn true or false into a question that makes you produce the answer.",
          "Divisez les fiches listes en une fiche par élément, et transformez le vrai ou faux en question qui oblige à produire la réponse.") },
      { wrong: B("Studying the cards without checking them first.",
          "Apprendre les fiches sans les avoir vérifiées."),
        fix: B("Check each card against its source line before your first session. A false card costs twice: once to learn it, once to unlearn it.",
          "Vérifiez chaque fiche sur sa ligne source avant la première séance. Une fiche fausse coûte deux fois : pour l'apprendre, puis pour la désapprendre.") },
    ],
    recap: [
      B("Cards work through active recall: answer before you look.", "Les fiches agissent par le rappel actif : répondez avant de regarder."),
      B("One idea per card, and a question that makes you produce.", "Une idée par fiche, et une question qui oblige à produire."),
      B("Every card is traced to a line of your notes.", "Chaque fiche renvoie à une ligne de vos notes."),
      B("Check the deck before studying it; delete what you cannot trace.", "Vérifiez le jeu avant de l'apprendre ; supprimez ce qui est introuvable."),
    ],
    further: B("Use a flashcard app that schedules reviews for you, and import your cards in the \"question | answer\" format. Add new cards after each lecture rather than all at once before the exam, so each card gets several reviews.",
      "Utilisez une application de fiches qui planifie les révisions pour vous, et importez vos fiches au format « question | réponse ». Ajoutez de nouvelles fiches après chaque cours plutôt que toutes à la veille de l'examen, pour que chacune soit révisée plusieurs fois."),
    more: [
      { q: B("What is the best way to study a card?",
          "Quelle est la meilleure façon de travailler une fiche ?"),
        options: [
          B("Read the question and answer together, several times", "Lire question et réponse ensemble, plusieurs fois"),
          B("Say the answer aloud before turning the card", "Dire la réponse à voix haute avant de retourner la fiche"),
          B("Copy the answer by hand to memorise it", "Recopier la réponse à la main pour la mémoriser"),
          B("Highlight the key words of the answer", "Surligner les mots clés de la réponse"),
        ],
        answer: 1,
        why: B("Producing the answer before seeing it is the recall that strengthens memory. Reading, copying and highlighting keep the answer in sight and skip that effort.",
          "Produire la réponse avant de la voir, c'est le rappel qui renforce la mémoire. Lire, recopier et surligner gardent la réponse sous les yeux et évitent cet effort.") },
      { q: B("Your exam asks you to solve short cases. What share of your cards should be cases?",
          "Votre examen demande de résoudre de courts cas. Quelle part de vos fiches devrait porter sur des cas ?"),
        options: [
          B("None: flashcards are only meant for learning definitions by heart", "Aucune : les fiches servent seulement à apprendre des définitions"),
          B("All of them, definitions are useless", "Toutes, les définitions sont inutiles"),
          B("Only one or two, at the end of the deck", "Une ou deux seulement, en fin de jeu"),
          B("A good share, a third or more, beside the definitions", "Une bonne part, un tiers ou plus, à côté des définitions"),
        ],
        answer: 3,
        why: B("Cards should train what the exam asks. Definitions are needed to apply rules, but only cases train you to recognise which rule applies.",
          "Les fiches doivent entraîner ce que demande l'examen. Les définitions servent à appliquer les règles, mais seuls les cas entraînent à reconnaître quelle règle s'applique.") },
    ],
  },

  'st-revise/st-quiz': {
    intro: B("Being quizzed is one of the most effective ways to learn, provided you answer before seeing the answer and come back to what you missed. An AI makes a patient examiner: it can ask questions in your exam's format, wait for your reply, explain in two sentences why you were right or wrong, and keep track of your misses. In this dojo you set up such a quiz on one chapter: one question at a time, answer hidden, mostly questions that apply ideas to new cases, and a list of misses at the end. That list becomes the plan for your next session.",
      "Se faire interroger est l'une des façons d'apprendre les plus efficaces, à condition de répondre avant de voir la réponse et de revenir sur ses erreurs. Une IA fait un examinateur patient : elle peut poser des questions au format de votre examen, attendre votre réponse, expliquer en deux phrases pourquoi vous aviez raison ou tort, et garder la trace de vos erreurs. Dans ce dojo, vous montez un tel quiz sur un chapitre : une question à la fois, réponse cachée, surtout des questions qui appliquent les notions à des cas nouveaux, et la liste des erreurs à la fin. Cette liste devient le programme de votre séance suivante."),
    concepts: [
      { term: B('Retrieval practice', 'Pratique du rappel'),
        def: B("Studying by answering questions from memory rather than by rereading. A quiz is retrieval practice only if you answer before you see the answer.",
          "Étudier en répondant de mémoire à des questions plutôt qu'en relisant. Un quiz n'est une pratique du rappel que si vous répondez avant de voir la réponse.") },
      { term: B('Transfer question', 'Question de transfert'),
        def: B("A question that asks you to apply an idea to a situation you have not seen, such as a new patient case. It tests understanding, not memory of the wording.",
          "Une question qui demande d'appliquer une notion à une situation inédite, comme un nouveau cas de patient. Elle teste la compréhension, et non le souvenir de la formulation.") },
      { term: B('Error log', "Journal d'erreurs"),
        def: B("The list of questions you missed, with the idea each one points to. It shows where to spend your next study hour.",
          "La liste des questions manquées, avec la notion que chacune révèle. Il indique où passer votre prochaine heure de travail.") },
      { term: B('Immediate feedback', 'Retour immédiat'),
        def: B("A short explanation right after each answer. It corrects an error before it settles, but only once you have committed to an answer.",
          "Une courte explication juste après chaque réponse. Elle corrige une erreur avant qu'elle ne s'installe, mais seulement une fois que vous vous êtes engagé sur une réponse.") },
    ],
    walkthrough: {
      title: B("Chloé runs a blind quiz on cardiac pharmacology ten days before her exam",
        "Chloé mène un quiz à l'aveugle en pharmacologie cardiaque, dix jours avant son examen"),
      steps: [
        B("Chloé pastes her chapter notes and states her exam format: short clinical cases. The format tells the AI what kind of questions to write.",
          "Chloé colle ses notes du chapitre et précise le format de son examen : de courts cas cliniques. Le format indique à l'IA quel type de questions écrire."),
        B("She sets the rules: one question at a time, no answer until she replies, feedback in two sentences with the line of her notes. The line lets her reread the exact passage after a miss.",
          "Elle pose les règles : une question à la fois, aucune réponse avant la sienne, un retour en deux phrases avec la ligne de ses notes. La ligne lui permet de relire le passage exact après une erreur."),
        B("First case: a patient on a beta blocker whose heart rate drops to 48. Chloé writes her answer before sending. Committing to an answer, even an unsure one, is what makes the feedback stick.",
          "Premier cas : un patient sous bêtabloquant dont la fréquence cardiaque tombe à 48. Chloé écrit sa réponse avant d'envoyer. S'engager sur une réponse, même incertaine, est ce qui fait retenir le retour."),
        B("After 15 questions, the AI stops and gives her score, 11 out of 15, and four misses. Three of them point to the same idea: drug interactions with potassium.",
          "Après 15 questions, l'IA s'arrête et donne son score, 11 sur 15, et quatre erreurs. Trois d'entre elles renvoient à la même notion : les interactions médicamenteuses avec le potassium."),
        B("Chloé rereads that section of her notes, makes two flashcards, and schedules a new quiz on potassium interactions only, two days later, with reworded cases.",
          "Chloé relit cette partie de ses notes, fait deux fiches, et planifie deux jours plus tard un nouveau quiz sur les seules interactions avec le potassium, avec des cas reformulés."),
      ],
    },
    mistakes: [
      { wrong: B("Asking for all the questions and answers in one list.",
          "Demander toutes les questions et les réponses en une seule liste."),
        fix: B("Require one question at a time and no answer before yours. The effort of answering blind is what makes a quiz better than rereading.",
          "Exigez une question à la fois et aucune réponse avant la vôtre. L'effort de répondre à l'aveugle est ce qui rend un quiz meilleur qu'une relecture.") },
      { wrong: B("Answering in your head, then reading the correction.",
          "Répondre dans sa tête, puis lire la correction."),
        fix: B("Write your answer, even in three words, before sending. A silent answer is easy to adjust afterwards, and you will count as right what you only half knew.",
          "Écrivez votre réponse, même en trois mots, avant d'envoyer. Une réponse silencieuse s'ajuste facilement après coup, et vous compterez juste ce que vous ne saviez qu'à moitié.") },
      { wrong: B("Ending the session on the score and forgetting the misses.",
          "Terminer la séance sur le score en oubliant les erreurs."),
        fix: B("Save the list of misses with the idea behind each, and schedule a quiz on those ideas only, two days later, with new wording.",
          "Gardez la liste des erreurs avec la notion derrière chacune, et programmez deux jours plus tard un quiz sur ces seules notions, formulé autrement.") },
    ],
    recap: [
      B("Answer before you see the answer, in writing.", "Répondez avant de voir la réponse, par écrit."),
      B("Ask for questions in your exam's format, mostly new cases.", "Demandez des questions au format de votre examen, surtout des cas nouveaux."),
      B("The list of misses matters more than the score.", "La liste des erreurs compte plus que le score."),
      B("Come back to the misses two days later, reworded.", "Revenez sur les erreurs deux jours plus tard, reformulées."),
    ],
    further: B("Keep one error log per subject across the semester. Before each exam, the ideas that appear most often in the log are your priority list, and they tell you which chapters deserve a mock exam.",
      "Tenez un journal d'erreurs par matière tout au long du semestre. Avant chaque examen, les notions qui y reviennent le plus forment votre liste de priorités, et désignent les chapitres qui méritent un examen blanc."),
    more: [
      { q: B("You are unsure of your answer. What should you do before sending it?",
          "Vous n'êtes pas sûr de votre réponse. Que faire avant de l'envoyer ?"),
        options: [
          B("Ask the AI for a small hint first", "Demander d'abord un petit indice à l'IA"),
          B("Skip this question for now and come back to it at the very end", "Passer cette question et n'y revenir qu'à la toute fin"),
          B("Write your best answer and send it anyway", "Écrire votre meilleure réponse et l'envoyer quand même"),
        ],
        answer: 2,
        why: B("Committing to an answer, even a wrong one, makes the correction memorable. A hint or a skipped question removes the effort that makes the quiz work.",
          "S'engager sur une réponse, même fausse, rend la correction mémorable. Un indice ou une question sautée retire l'effort qui fait fonctionner le quiz.") },
      { q: B("Three of your four misses point to the same idea. What does that tell you?",
          "Trois de vos quatre erreurs renvoient à la même notion. Qu'est-ce que cela vous apprend ?"),
        options: [
          B("The questions on that idea were badly written", "Les questions sur cette notion étaient mal écrites"),
          B("That idea is your priority for the next session", "Cette notion est votre priorité pour la séance suivante"),
          B("You should quiz the whole chapter again tomorrow", "Il faut refaire tout le chapitre dès demain"),
        ],
        answer: 1,
        why: B("Several misses on one idea show a real gap, not bad luck. Reviewing that idea, then being quizzed on it with new cases, is the most efficient next hour.",
          "Plusieurs erreurs sur une même notion révèlent une vraie lacune, et non de la malchance. Revoir cette notion, puis être interrogé dessus avec des cas nouveaux, est l'heure suivante la plus efficace.") },
    ],
  },

  'st-revise/st-spaced': {
    intro: B("How you spread your revision matters as much as how long you revise. The same ten hours on a chapter give far better memory when spread over several sessions with growing gaps than when packed into one evening. This is the spacing effect, one of the best established results about learning, and mixing subjects within a week, called interleaving, adds to it. In this dojo you give the AI your exam dates, your chapters and your real free hours, and it builds a dated plan that brings each chapter back at growing gaps, keeps a free slot for delays, and ends with mock exams.",
      "La façon dont vous répartissez vos révisions compte autant que leur durée. Les mêmes dix heures sur un chapitre donnent une bien meilleure mémoire réparties sur plusieurs séances de plus en plus espacées que concentrées sur une soirée. C'est l'effet d'espacement, l'un des résultats les mieux établis sur l'apprentissage, et alterner les matières dans la semaine, ce que l'on appelle l'entrelacement, s'y ajoute. Dans ce dojo, vous donnez à l'IA vos dates d'examen, vos chapitres et vos heures libres réelles, et elle construit un plan daté qui fait revenir chaque chapitre à intervalles croissants, garde un créneau pour les retards et se termine par des examens blancs."),
    concepts: [
      { term: B('Spacing effect', "Effet d'espacement"),
        def: B("Memory lasts longer when study sessions are spread out over time than when they are grouped together, for the same total time.",
          "La mémoire dure plus longtemps quand les séances d'étude sont étalées dans le temps que lorsqu'elles sont groupées, à temps total égal.") },
      { term: B('Expanding intervals', 'Intervalles croissants'),
        def: B("Reviewing after gaps that grow each time, for example one day, three days, one week, two weeks. Each review comes just as you begin to forget.",
          "Réviser après des intervalles qui s'allongent à chaque fois, par exemple un jour, trois jours, une semaine, deux semaines. Chaque révision arrive au moment où l'on commence à oublier.") },
      { term: B('Interleaving', 'Entrelacement'),
        def: B("Mixing different subjects or types of problems in one session. It feels harder, but it trains you to recognise which method a problem needs.",
          "Mêler plusieurs matières ou types de problèmes dans une même séance. Cela paraît plus difficile, mais entraîne à reconnaître la méthode qu'exige un problème.") },
      { term: B('Buffer slot', 'Créneau tampon'),
        def: B("A time slot left empty on purpose each week to absorb delays. Without it, one missed evening pushes the whole plan back.",
          "Un créneau laissé vide à dessein chaque semaine pour absorber les retards. Sans lui, une soirée manquée décale tout le plan.") },
    ],
    walkthrough: {
      title: B("Maxime plans five weeks of revision for four biology exams",
        "Maxime planifie cinq semaines de révision pour quatre examens de biologie"),
      steps: [
        B("Maxime lists his four exams with their dates and number of chapters, then his real free hours: weekday evenings from 6 to 8:30 pm, nothing at weekends because of his job. Honest hours make a plan he will actually follow.",
          "Maxime liste ses quatre examens avec leurs dates et leur nombre de chapitres, puis ses heures libres réelles : les soirs de semaine de 18 h à 20 h 30, rien le week-end à cause de son emploi. Des heures honnêtes donnent un plan qu'il suivra vraiment."),
        B("He asks for each chapter to be studied once, then reviewed at growing gaps. For genetics chapter 1, studied on 13 May, reviews fall on 14 May, 17 May, 24 May and 7 June.",
          "Il demande que chaque chapitre soit étudié une fois, puis révisé à intervalles croissants. Pour le chapitre 1 de génétique, étudié le 13 mai, les révisions tombent le 14 mai, le 17 mai, le 24 mai et le 7 juin."),
        B("He requires at least two subjects each evening. The AI pairs a new genetics chapter with an ecology review, so every evening mixes first study and recall.",
          "Il exige au moins deux matières chaque soir. L'IA associe un nouveau chapitre de génétique à une révision d'écologie, si bien que chaque soirée mêle première étude et rappel."),
        B("He keeps Friday evenings free and asks for one timed mock per subject in the last ten days. The AI places them two to four days before each exam, leaving time to fix what the mock reveals.",
          "Il garde le vendredi soir libre et demande un examen blanc chronométré par matière dans les dix derniers jours. L'IA les place deux à quatre jours avant chaque examen, ce qui laisse le temps de corriger ce qu'ils révèlent."),
        B("Finally he asks which exam is most at risk. The AI answers biochemistry: seven chapters, and the last one gets only two reviews. Maxime moves one ecology review to make room.",
          "Enfin, il demande quel examen est le plus menacé. L'IA répond la biochimie : sept chapitres, et le dernier n'a que deux révisions. Maxime déplace une révision d'écologie pour faire de la place."),
      ],
    },
    mistakes: [
      { wrong: B("Giving ideal hours instead of the hours you really have.",
          "Indiquer des heures idéales au lieu des heures réellement disponibles."),
        fix: B("Count your classes, job, travel and rest first, then give only what is left. A plan that exceeds your week is abandoned by the second week.",
          "Comptez d'abord cours, emploi, trajets et repos, puis ne donnez que ce qui reste. Un plan qui dépasse votre semaine est abandonné dès la deuxième.") },
      { wrong: B("Planning one subject per week, in the order of the exams.",
          "Prévoir une matière par semaine, dans l'ordre des examens."),
        fix: B("Ask for every subject to come back regularly, mixed within the week. Otherwise the first subject studied has not been seen for a month by its exam.",
          "Demandez que chaque matière revienne régulièrement, mêlée aux autres dans la semaine. Sinon, la première matière étudiée n'a pas été revue depuis un mois le jour de son examen.") },
      { wrong: B("Filling every slot, with no room for delays.",
          "Remplir chaque créneau, sans place pour les retards."),
        fix: B("Keep one free slot per week. When you fall behind, ask the AI to reschedule into it first, instead of adding hours you do not have.",
          "Gardez un créneau libre par semaine. En cas de retard, demandez à l'IA de replanifier d'abord dans ce créneau, au lieu d'ajouter des heures que vous n'avez pas.") },
    ],
    recap: [
      B("Spread each chapter over several sessions with growing gaps.", "Répartissez chaque chapitre sur plusieurs séances de plus en plus espacées."),
      B("Mix subjects within a week rather than one per week.", "Alternez les matières dans la semaine plutôt qu'une par semaine."),
      B("Give the AI your real hours, not ideal ones.", "Donnez à l'IA vos heures réelles, pas des heures idéales."),
      B("Keep a free slot each week and end with timed mock exams.", "Gardez un créneau libre par semaine et terminez par des examens blancs chronométrés."),
    ],
    further: B("Each Sunday, compare the plan with what you actually did and ask the AI to reschedule the coming week within the same hours. After two or three weeks you will know your real pace, and next semester's plan will be accurate from the start.",
      "Chaque dimanche, comparez le plan avec ce que vous avez réellement fait et demandez à l'IA de replanifier la semaine suivante dans les mêmes heures. Après deux ou trois semaines, vous connaîtrez votre vrai rythme, et le plan du semestre suivant sera juste dès le départ."),
    more: [
      { q: B("A chapter was studied on Monday. Which review schedule follows expanding intervals?",
          "Un chapitre a été étudié lundi. Quel calendrier de révision suit des intervalles croissants ?"),
        options: [
          B("Tuesday, Thursday, next Monday, two weeks later", "Mardi, jeudi, le lundi suivant, deux semaines plus tard"),
          B("Every single day for the next ten days, at the same time of day", "Chaque jour pendant les dix jours suivants, à la même heure"),
          B("Once, the evening before the exam", "Une fois, la veille de l'examen"),
          B("Every Monday until the exam", "Tous les lundis jusqu'à l'examen"),
        ],
        answer: 0,
        why: B("The gaps grow: one day, two days, four days, then two weeks. Reviewing every day wastes time on what you still remember; reviewing once leaves too long a gap.",
          "Les intervalles s'allongent : un jour, deux jours, quatre jours, puis deux semaines. Réviser chaque jour gaspille du temps sur ce que vous savez encore ; réviser une fois laisse un trop long intervalle.") },
      { q: B("Why does mixing subjects in one evening feel harder, and why is that useful?",
          "Pourquoi alterner les matières dans une soirée paraît-il plus difficile, et pourquoi est-ce utile ?"),
        options: [
          B("It is harder because you get tired faster, and that builds your stamina for exams", "On se fatigue plus vite, et cela forge votre endurance pour les examens"),
          B("It is not useful; it only feels productive", "Ce n'est pas utile ; cela donne seulement l'impression d'avancer"),
          B("You must first recognise what each problem needs, as in the exam", "Il faut d'abord reconnaître ce qu'exige chaque problème, comme à l'examen"),
        ],
        answer: 2,
        why: B("In one-subject sessions, you know which method to use before reading the problem. Mixed sessions make you choose, which is exactly what an exam paper requires.",
          "Dans une séance consacrée à une seule matière, vous savez quelle méthode employer avant de lire le problème. Les séances mêlées vous obligent à choisir, exactement ce qu'exige un sujet d'examen.") },
    ],
  },
  ...
  'st-exams/st-mock': {
    intro: B("Knowing your course and passing its exam are two different things. The exam adds time pressure, no notes and a set format, and many students lose points on these alone. A mock exam in real conditions is the only way to train for them. In this dojo you give the AI a past paper and its grading scheme, get a new paper of the same shape without solutions, sit it timed and closed book, then have it marked question by question against the scheme. You check two marks yourself, because models tend to be generous, and you turn the result into revision priorities.",
      "Connaître son cours et réussir son examen sont deux choses différentes. L'examen ajoute la pression du temps, l'absence de notes et un format imposé, et beaucoup d'étudiants perdent des points sur ces seuls aspects. Un examen blanc en conditions réelles est le seul moyen de s'y entraîner. Dans ce dojo, vous donnez à l'IA une annale et son barème, obtenez un nouveau sujet de même forme sans corrigé, le passez en temps limité et sans documents, puis le faites corriger question par question selon le barème. Vous vérifiez vous-même deux notes, car les modèles ont tendance à être généreux, et transformez le résultat en priorités de révision."),
    concepts: [
      { term: B('Past paper', 'Annale'),
        def: B("A real exam from a previous year. It shows the structure, the question types and the level your teacher expects better than any description.",
          "Un vrai sujet d'une année précédente. Il montre la structure, les types de questions et le niveau attendus par l'enseignant mieux que toute description.") },
      { term: B('Grading scheme', 'Barème'),
        def: B("The list of points awarded for each element of an answer. It turns marking from an impression into a check, element by element.",
          "La liste des points accordés pour chaque élément d'une réponse. Il transforme la correction d'une impression en une vérification, élément par élément.") },
      { term: B('Exam conditions', "Conditions d'examen"),
        def: B("Sitting a paper with the real time limit, no notes and no help. Without them, a mock only measures what you know with support.",
          "Composer avec la vraie limite de temps, sans notes ni aide. Sans elles, un examen blanc ne mesure que ce que vous savez avec un appui.") },
      { term: B('Leniency bias', "Biais d'indulgence"),
        def: B("The tendency of a marker, human or AI, to give more points than the scheme allows, often rewarding length or good intentions.",
          "La tendance d'un correcteur, humain ou IA, à accorder plus de points que le barème ne le permet, souvent en récompensant la longueur ou les bonnes intentions.") },
    ],
    walkthrough: {
      title: B("Yanis sits a mock microeconomics exam two weeks before the real one",
        "Yanis passe un examen blanc de microéconomie deux semaines avant le vrai"),
      steps: [
        B("Yanis pastes a past paper and its grading scheme and asks for a new paper with the same structure: three exercises, same points, two hours. The past paper is the template; new data keep him from recognising answers.",
          "Yanis colle une annale et son barème et demande un nouveau sujet de même structure : trois exercices, mêmes points, deux heures. L'annale sert de modèle ; de nouvelles données l'empêchent de reconnaître les réponses."),
        B("He asks for the paper only, no solutions. If the solutions were on the same page, his eye would catch them and the mock would lose its value.",
          "Il demande le sujet seul, sans corrigé. Si le corrigé figurait sur la même page, son œil l'accrocherait et l'examen blanc perdrait sa valeur."),
        B("He sits it at his desk with a two-hour timer, phone in another room and the chat closed. Real conditions reveal what he cannot yet do fast enough.",
          "Il compose à son bureau avec un minuteur de deux heures, téléphone dans une autre pièce et conversation fermée. Les conditions réelles révèlent ce qu'il ne sait pas encore faire assez vite."),
        B("He pastes his answers and asks for strict marking, with the criterion quoted for each point given or refused. The AI gives 13 out of 20 and shows he lost 4 points on elasticities.",
          "Il colle ses réponses et demande une correction stricte, avec le critère cité pour chaque point accordé ou refusé. L'IA donne 13 sur 20 et montre qu'il a perdu 4 points sur les élasticités."),
        B("He checks two marks himself against the scheme. One is too generous: a graph without labelled axes got full marks. He asks for a stricter pass, then puts elasticities first in next week's plan.",
          "Il vérifie lui-même deux notes au regard du barème. L'une est trop généreuse : un graphique sans axes légendés a obtenu tous ses points. Il demande une correction plus stricte, puis place les élasticités en tête du plan de la semaine suivante."),
      ],
    },
    mistakes: [
      { wrong: B("Asking for a practice exam without giving a past paper or the announced format.",
          "Demander un examen d'entraînement sans fournir d'annale ni le format annoncé."),
        fix: B("Give a past paper, or at least the duration, question types and weighting your teacher announced. Otherwise you train for a generic exam, not yours.",
          "Fournissez une annale, ou au moins la durée, les types de questions et la pondération annoncés par l'enseignant. Sinon, vous vous entraînez à un examen générique, et non au vôtre.") },
      { wrong: B("Sitting the mock with notes nearby or the conversation open.",
          "Passer l'examen blanc avec des notes à portée ou la conversation ouverte."),
        fix: B("Set a timer, put everything away and sit the whole paper in one go. A mock with support measures your notes, not your readiness.",
          "Réglez un minuteur, rangez tout et composez le sujet entier d'une traite. Un examen blanc avec appui mesure vos notes, et non votre préparation.") },
      { wrong: B("Accepting the AI's mark without checking any part of it.",
          "Accepter la note de l'IA sans en vérifier aucune partie."),
        fix: B("Check two marks against the scheme yourself. If one is too generous, ask for a strict re-marking with each criterion quoted.",
          "Vérifiez vous-même deux notes au regard du barème. Si l'une est trop généreuse, demandez une nouvelle correction stricte, critère par critère.") },
    ],
    recap: [
      B("A mock trains the performance: time, no notes, the real format.", "L'examen blanc entraîne la performance : le temps, l'absence de notes, le vrai format."),
      B("A past paper and its grading scheme are the best template.", "Une annale et son barème sont le meilleur modèle."),
      B("Ask for the paper without solutions, and sit it in real conditions.", "Demandez le sujet sans corrigé, et passez-le en conditions réelles."),
      B("Every mark must cite a criterion; check two yourself.", "Chaque note doit citer un critère ; vérifiez-en deux vous-même."),
    ],
    further: B("Plan two mocks per subject: one about three weeks before the exam to find weak chapters, one a few days before to check they are fixed. Compare the two marks chapter by chapter to see where your revision worked.",
      "Prévoyez deux examens blancs par matière : l'un environ trois semaines avant l'examen pour trouver les chapitres faibles, l'autre quelques jours avant pour vérifier qu'ils sont réparés. Comparez les deux notes chapitre par chapitre pour voir où vos révisions ont porté."),
    more: [
      { q: B("Why ask for the mock paper without its solutions?",
          "Pourquoi demander le sujet blanc sans son corrigé ?"),
        options: [
          B("To keep the reply short enough to read", "Pour que la réponse reste assez courte à lire"),
          B("Because the AI is not able to solve a paper it has just written itself", "Parce que l'IA ne sait pas résoudre un sujet qu'elle vient d'écrire"),
          B("So the teacher cannot tell you used AI", "Pour que l'enseignant ne voie pas l'usage de l'IA"),
          B("So you cannot see the answers before sitting it", "Pour ne pas voir les réponses avant de composer"),
        ],
        answer: 3,
        why: B("Solutions on the same page get read, even involuntarily. The mock then measures recognition, not what you can produce under time pressure.",
          "Un corrigé sur la même page se lit, même sans le vouloir. L'examen blanc mesure alors la reconnaissance, et non ce que vous savez produire sous la pression du temps.") },
      { q: B("The AI finds your answer long and detailed and gives full points, but the expected formula is missing. What happened?",
          "L'IA juge votre réponse longue et détaillée et lui donne tous les points, mais la formule attendue manque. Que s'est-il passé ?"),
        options: [
          B("Leniency: length was rewarded instead of the criterion", "De l'indulgence : la longueur a été récompensée au lieu du critère"),
          B("Nothing wrong: a detailed explanation is worth as much as the expected formula", "Rien d'anormal : une explication détaillée vaut la formule attendue"),
          B("The grading scheme must be wrong", "Le barème doit être erroné"),
        ],
        answer: 0,
        why: B("The scheme gives points for the formula; length is not a criterion. Ask the AI to re-mark strictly, quoting the criterion for every point.",
          "Le barème accorde des points pour la formule ; la longueur n'est pas un critère. Demandez à l'IA une nouvelle correction stricte, en citant le critère de chaque point.") },
    ],
  },

  'st-exams/st-cite': {
    intro: B("In written work, every source you cite must exist, say what you claim, and be referenced correctly. AI can fail the first two in a way that is hard to spot: asked for sources from memory, a model can produce references that look perfect (plausible authors, a real journal, a DOI) and do not exist. Citing one in an essay is treated as a serious fault. In this dojo you search with your library's catalogue and databases, open each source, and use the AI for what it does well: formatting real records in the style your course requires, with a rule that it adds or completes nothing.",
      "Dans un travail écrit, chaque source citée doit exister, dire ce que vous affirmez, et être référencée correctement. L'IA peut échouer sur les deux premiers points d'une façon difficile à repérer : sollicité pour des sources de mémoire, un modèle peut produire des références parfaites en apparence (des auteurs plausibles, une vraie revue, un DOI) qui n'existent pas. En citer une dans un essai est traité comme une faute grave. Dans ce dojo, vous cherchez avec le catalogue et les bases de votre bibliothèque, ouvrez chaque source, et employez l'IA pour ce qu'elle fait bien : mettre en forme de vraies notices dans le style exigé, avec la règle de ne rien ajouter ni compléter."),
    concepts: [
      { term: B('Fabricated reference', 'Référence inventée'),
        def: B("A citation produced by a model that looks real but matches no existing document. It comes from the model predicting a likely-looking reference, not from a search.",
          "Une citation produite par un modèle, réaliste en apparence, qui ne correspond à aucun document existant. Elle vient de la prédiction d'une référence vraisemblable, et non d'une recherche.") },
      { term: B('Bibliographic record', 'Notice bibliographique'),
        def: B("The description of a document in a catalogue or database: authors, year, title, publisher or journal, pages, identifiers. It is the reliable basis for a citation.",
          "La description d'un document dans un catalogue ou une base : auteurs, année, titre, éditeur ou revue, pages, identifiants. C'est la base fiable d'une citation.") },
      { term: B('Citation style', 'Style de citation'),
        def: B("A set of formatting rules for references, such as APA, MLA or Chicago. Your course or department usually requires one.",
          "Un ensemble de règles de mise en forme des références, comme APA, MLA ou Chicago. Votre cours ou votre département en impose généralement un.") },
      { term: B('DOI', 'DOI'),
        def: B("Digital Object Identifier, a permanent identifier for an article. Resolving it online leads to the document, a quick way to check that a reference exists.",
          "Digital Object Identifier, identifiant permanent d'un article. Le résoudre en ligne mène au document, ce qui permet de vérifier vite qu'une référence existe.") },
    ],
    walkthrough: {
      title: B("Emma gathers and formats three sources for a sociology essay",
        "Emma rassemble et met en forme trois sources pour un essai de sociologie"),
      steps: [
        B("Emma searches her library's database with the keywords \"telework\", \"remote work\" and \"loneliness\", filtered to peer-reviewed articles since 2018. Searching the database guarantees that every result exists.",
          "Emma cherche dans la base de sa bibliothèque avec les mots clés « télétravail », « travail à distance » et « isolement », filtrés sur les articles évalués par les pairs depuis 2018. Chercher dans la base garantit que chaque résultat existe."),
        B("She opens the five most relevant results, reads their abstracts and conclusions, and keeps three that actually support her argument. A title can promise more than the article delivers.",
          "Elle ouvre les cinq résultats les plus pertinents, lit leurs résumés et leurs conclusions, et en garde trois qui soutiennent vraiment son argument. Un titre peut promettre davantage que ce que l'article apporte."),
        B("She copies the three records as displayed and notes the page of the passage she will quote. The page is needed for the in-text citation, and only the document can give it.",
          "Elle recopie les trois notices telles qu'affichées et note la page du passage qu'elle citera. La page est nécessaire à la citation dans le texte, et seul le document peut la donner."),
        B("She pastes the records and asks for APA references with one rule: add nothing, complete nothing, write MISSING if a field is absent. One record lacks the issue number; the AI marks it MISSING instead of inventing it.",
          "Elle colle les notices et demande des références APA avec une règle : ne rien ajouter, ne rien compléter, écrire MANQUANT si un champ est absent. Une notice n'a pas de numéro de fascicule ; l'IA écrit MANQUANT au lieu de l'inventer."),
        B("She finds the issue number on the journal's page, then compares each reference with its record: names, year, pages. One author's initial was wrong in her copy; she fixes it.",
          "Elle retrouve le numéro sur la page de la revue, puis compare chaque référence avec sa notice : noms, année, pages. L'initiale d'un auteur était fausse dans sa copie ; elle la corrige."),
      ],
    },
    mistakes: [
      { wrong: B("Asking the AI for sources on a topic and citing them directly.",
          "Demander à l'IA des sources sur un sujet et les citer directement."),
        fix: B("Search your library catalogue or a recommended database. If the AI suggests a reference, treat it as a lead: find it in the catalogue and open it before using it.",
          "Cherchez dans le catalogue de la bibliothèque ou une base recommandée. Si l'IA suggère une référence, traitez-la comme une piste : retrouvez-la dans le catalogue et ouvrez-la avant de l'employer.") },
      { wrong: B("Citing an article after reading only its title or abstract.",
          "Citer un article après n'en avoir lu que le titre ou le résumé."),
        fix: B("Read at least the part you rely on, and note its page. You are responsible for what you attribute to an author, and abstracts often simplify.",
          "Lisez au moins la partie sur laquelle vous vous appuyez, et notez sa page. Vous répondez de ce que vous attribuez à un auteur, et les résumés simplifient souvent.") },
      { wrong: B("Letting the AI fill in missing fields such as pages or volume.",
          "Laisser l'IA compléter les champs manquants, comme les pages ou le volume."),
        fix: B("Forbid any completion and ask for MISSING in the gap. Then find the field yourself in the document or on the publisher's page.",
          "Interdisez toute complétion et demandez MANQUANT à la place du vide. Retrouvez ensuite le champ vous-même dans le document ou sur la page de l'éditeur.") },
    ],
    recap: [
      B("Search for sources in library tools, never in the chat.", "Cherchez les sources dans les outils de la bibliothèque, jamais dans la conversation."),
      B("Open and read what you cite, and note the page.", "Ouvrez et lisez ce que vous citez, et notez la page."),
      B("Use AI to format real records, and forbid it to add anything.", "Employez l'IA pour mettre en forme de vraies notices, et interdisez-lui tout ajout."),
      B("Compare each formatted reference with its record.", "Comparez chaque référence mise en forme avec sa notice."),
    ],
    further: B("Ask your library about a reference manager, often free for students. It stores your records as you find them and formats citations in any style, which leaves the AI only occasional checks. Many libraries also run short training sessions on their databases.",
      "Renseignez-vous auprès de votre bibliothèque sur un gestionnaire de références, souvent gratuit pour les étudiants. Il stocke vos notices au fil des recherches et met en forme les citations dans tous les styles, ce qui ne laisse à l'IA que des vérifications ponctuelles. Beaucoup de bibliothèques proposent aussi de courtes formations à leurs bases."),
    more: [
      { q: B("An AI tool with web search shows a link beside a summary. What must you still do?",
          "Un outil d'IA doté d'une recherche web affiche un lien à côté d'un résumé. Que devez-vous encore faire ?"),
        options: [
          B("Nothing, the link proves the source exists", "Rien, le lien prouve que la source existe"),
          B("Open the link and check it says what the summary claims", "Ouvrir le lien et vérifier qu'il dit ce qu'affirme le résumé"),
          B("Copy the summary into your essay, with the link as the reference for it", "Recopier le résumé dans votre essai, avec le lien comme référence"),
        ],
        answer: 1,
        why: B("A link shows that a page exists, not that it supports the claim. Summaries can distort or mix sources; only the page itself counts.",
          "Un lien montre qu'une page existe, pas qu'elle soutient l'affirmation. Les résumés peuvent déformer ou mélanger les sources ; seule la page elle-même compte.") },
      { q: B("At which step of citing is the AI most reliable?",
          "À quelle étape de la citation l'IA est-elle la plus fiable ?"),
        options: [
          B("Finding the best and most recent sources on your essay topic", "Trouver les sources les meilleures et les plus récentes sur votre sujet"),
          B("Recalling the page where a quote appears", "Se souvenir de la page où figure une citation"),
          B("Formatting a real record in a given style", "Mettre en forme une vraie notice dans un style donné"),
        ],
        answer: 2,
        why: B("Formatting is a mechanical task on data you supply. Finding sources and recalling pages ask the model to remember facts, which is exactly where it invents.",
          "La mise en forme est une tâche mécanique sur des données que vous fournissez. Trouver des sources ou retrouver des pages exige de se souvenir de faits, précisément là où le modèle invente.") },
    ],
  },

  'st-exams/st-draft': {
    intro: B("Feedback on a draft is one of the best uses of AI for a student, and rewriting is one of the most dangerous. The difference is simple: feedback names a problem and leaves the fix to you; rewriting fixes it for you, so the text is no longer entirely yours, and many institutions treat that as misconduct. In this dojo you check what your assignment allows, give the AI the marking criteria and your numbered draft, and ask for the three weakest points, each tied to a criterion, with a question to help you and no rewritten sentence. You then revise yourself, keep your versions, and declare the help if required.",
      "Les retours sur un brouillon sont l'un des meilleurs usages de l'IA pour un étudiant, et la réécriture l'un des plus dangereux. La différence est simple : un retour nomme un problème et vous laisse le corriger ; une réécriture le corrige à votre place, si bien que le texte n'est plus entièrement le vôtre, ce que beaucoup d'établissements traitent comme une fraude. Dans ce dojo, vous vérifiez ce que votre devoir autorise, donnez à l'IA les critères de notation et votre brouillon numéroté, et demandez les trois points les plus faibles, chacun relié à un critère, avec une question pour vous aider et aucune phrase réécrite. Vous révisez ensuite vous-même, gardez vos versions et déclarez l'aide si c'est exigé."),
    concepts: [
      { term: B('Feedback', 'Retour'),
        def: B("A comment that names a weakness and says why it matters, without doing the fix. It keeps the decision and the writing with you.",
          "Un commentaire qui nomme une faiblesse et dit pourquoi elle compte, sans faire la correction. Il vous laisse la décision et l'écriture.") },
      { term: B('Ghostwriting', 'Écriture par un tiers'),
        def: B("Handing in text written by someone or something else as your own. With AI, it includes accepting \"improved\" paragraphs or sentences, even in part.",
          "Rendre comme sien un texte écrit par quelqu'un ou quelque chose d'autre. Avec l'IA, cela inclut le fait d'accepter des paragraphes ou des phrases « améliorés », même en partie.") },
      { term: B('Marking criteria', 'Critères de notation'),
        def: B("The points on which your work is graded, often gathered in a rubric: argument, evidence, structure, style. Feedback tied to them targets what earns marks.",
          "Les points sur lesquels votre travail est noté, souvent réunis dans une grille : argumentation, preuves, structure, style. Des retours reliés à ces critères visent ce qui rapporte des points.") },
      { term: B('Version history', 'Historique des versions'),
        def: B("The successive saved states of your draft. It shows how your text grew, which protects you if its authorship is ever questioned.",
          "Les états successifs enregistrés de votre brouillon. Il montre comment votre texte a grandi, ce qui vous protège si sa paternité est un jour mise en doute.") },
    ],
    walkthrough: {
      title: B("Nora gets feedback on her history essay without letting the AI write it",
        "Nora obtient des retours sur son essai d'histoire sans laisser l'IA l'écrire"),
      steps: [
        B("Nora rereads the brief: AI feedback is allowed if declared, AI writing is not. She now knows the limit she must hold throughout the session.",
          "Nora relit la consigne : les retours d'une IA sont permis s'ils sont déclarés, l'écriture par une IA ne l'est pas. Elle connaît désormais la limite à tenir pendant toute la séance."),
        B("She saves her draft as version 1, numbers its paragraphs, and pastes the marking criteria first, then the draft. Criteria first tell the AI what to judge the text against.",
          "Elle enregistre son brouillon en version 1, numérote ses paragraphes, et colle d'abord les critères de notation, puis le brouillon. Les critères en premier indiquent à l'IA à quoi mesurer le texte."),
        B("She asks for the three weakest points, each tied to a criterion, with a question, and forbids any rewriting. The AI flags paragraph 4: a claim about wage increases with no source, against the criterion \"argument supported by evidence\".",
          "Elle demande les trois points les plus faibles, chacun relié à un critère, avec une question, et interdit toute réécriture. L'IA signale le paragraphe 4 : une affirmation sur les hausses de salaire sans source, au regard du critère « argumentation étayée »."),
        B("The question reads: \"Which figure from your sources shows the size of the increase?\" Nora finds the figure in her notes and rewrites the paragraph herself, with the citation.",
          "La question demande : « Quel chiffre de vos sources montre l'ampleur de la hausse ? » Nora retrouve le chiffre dans ses notes et réécrit elle-même le paragraphe, avec la citation."),
        B("She saves version 2 and writes her declaration: AI used for feedback on version 1 against the criteria, no text written by the AI. Her history of versions backs up the declaration.",
          "Elle enregistre la version 2 et rédige sa déclaration : IA utilisée pour des retours sur la version 1 selon les critères, aucun texte écrit par l'IA. L'historique de ses versions appuie la déclaration."),
      ],
    },
    mistakes: [
      { wrong: B("Asking the AI to \"improve\" or \"polish\" the draft.",
          "Demander à l'IA d'« améliorer » ou de « peaufiner » le brouillon."),
        fix: B("Ask for problems and questions only, tied to the criteria. \"Improve\" invites rewriting, and a rewritten text is no longer entirely yours.",
          "Ne demandez que des problèmes et des questions, reliés aux critères. « Améliorer » invite à réécrire, et un texte réécrit n'est plus entièrement le vôtre.") },
      { wrong: B("Giving the draft without the marking criteria.",
          "Fournir le brouillon sans les critères de notation."),
        fix: B("Paste the criteria or rubric first. Without them the AI comments on style in general; with them it points to what will actually cost you marks.",
          "Collez d'abord les critères ou la grille. Sans eux, l'IA commente le style en général ; avec eux, elle désigne ce qui vous coûtera réellement des points.") },
      { wrong: B("Overwriting the same file at each revision and forgetting the declaration.",
          "Écraser le même fichier à chaque révision et oublier la déclaration."),
        fix: B("Save a new version before and after each round of feedback, and write the declaration when you hand in, precisely: tool, step, what it did not do.",
          "Enregistrez une nouvelle version avant et après chaque série de retours, et rédigez la déclaration en rendant le travail, précisément : outil, étape, ce qu'il n'a pas fait.") },
    ],
    recap: [
      B("Feedback names a problem; rewriting takes the work from you.", "Un retour nomme un problème ; une réécriture vous prend le travail."),
      B("Check the assignment's rule before asking for anything.", "Vérifiez la règle du devoir avant toute demande."),
      B("Tie every comment to a marking criterion and a paragraph.", "Reliez chaque commentaire à un critère de notation et à un paragraphe."),
      B("Revise yourself, keep your versions, declare as required.", "Révisez vous-même, gardez vos versions, déclarez comme exigé."),
    ],
    further: B("After two or three essays, look at the feedback you received across them. If the same criterion comes up every time, such as unsupported claims, make it an item of your personal checklist and check it before asking for any feedback.",
      "Après deux ou trois essais, relisez l'ensemble des retours reçus. Si le même critère revient à chaque fois, par exemple les affirmations sans preuve, faites-en un point de votre liste personnelle et vérifiez-le avant toute demande de retours."),
    more: [
      { q: B("Which request stays on the side of feedback?",
          "Quelle demande reste du côté du retour ?"),
        options: [
          B("\"Which of my claims lack evidence, and where?\"", "« Quelles affirmations manquent de preuves, et où ? »"),
          B("\"Fix the grammar and make the tone more academic\"", "« Corrige la grammaire et rends le ton plus universitaire »"),
          B("\"Give me a stronger first sentence\"", "« Donne-moi une première phrase plus forte »"),
          B("\"Rewrite my conclusion in fewer words\"", "« Réécris ma conclusion en moins de mots »"),
        ],
        answer: 0,
        why: B("Only the first returns a diagnosis and leaves the writing to you. The others produce text, which is rewriting, even when the change seems small.",
          "Seule la première renvoie un diagnostic et vous laisse l'écriture. Les autres produisent du texte, donc de la réécriture, même quand la modification paraît minime.") },
      { q: B("A teacher questions whether your work is yours. What shows it best?",
          "Un enseignant doute que votre travail soit le vôtre. Qu'est-ce qui le montre le mieux ?"),
        options: [
          B("A statement that you did not use AI", "Une déclaration affirmant que vous n'avez pas utilisé l'IA"),
          B("A detector's result saying the text was written by a human", "Le résultat d'un détecteur jugeant le texte écrit par un humain"),
          B("The fact that the essay received a good mark", "Le fait que l'essai ait obtenu une bonne note"),
          B("Your saved versions and a precise declaration", "Vos versions enregistrées et une déclaration précise"),
        ],
        answer: 3,
        why: B("Versions show how the text was built, step by step, and a precise declaration shows what help you used. Detectors are unreliable, and a mark proves nothing about authorship.",
          "Les versions montrent comment le texte s'est construit, étape par étape, et une déclaration précise indique l'aide employée. Les détecteurs sont peu fiables, et une note ne prouve rien sur la paternité du texte.") },
    ],
  },
}
