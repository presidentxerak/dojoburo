...
const ENRICH: Record<string, Enrichment> = {
  ...
  'dv-frame/dv-secrets': {
    ...
    example: {
      ...
      before: B("Why does this fail?\nconfig.py:\nPAYMENT_KEY = \"live_51Hq...\"\nDB_URL = \"postgres://admin:Pa55word…\"\nlog: {\"email\": \"<the customer's real address>\", \"amount\": 129.00} 401 Unauthorized",
        "Pourquoi ça échoue ?\nconfig.py :\nPAYMENT_KEY = \"live_51Hq...\"\nDB_URL = \"postgres://admin:Pa55word…\"\nlog : {\"email\": \"<la vraie adresse du client>\", \"amount\": 129.00} 401 Unauthorized"),
