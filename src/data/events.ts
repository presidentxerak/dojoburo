...
export const EVENTS: GameEvent[] = [
  ...
  { id: 'outage', tag: 'OUTAGE', color: '#e2574c', title: 'Node outage', message: (w) => `A provider blips · ${w} retries and carries on.`, xp: 30, coins: 6, weight: 4, target: 'random', mood: 'work', good: false },
