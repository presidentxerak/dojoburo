...
const DISCOVERY: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas comprendre les huit mots que tout le monde emploie autour de toi sans jamais les expliquer.",
    ),
    ...
    steps: [
      ...
      B('A token is a piece of a word. You pay by the piece, not by the answer.',
        "Un jeton est un morceau de mot. Tu paies au morceau, pas à la réponse."),
      B('A prompt is the instruction. Context is everything you send with it.',
        "Une consigne est l'instruction. Le contexte, c'est tout ce que tu envoies avec."),
    ...
    quiz: {
      q: B('You are billed by the token. So what is a token?',
        'On te facture au jeton. Alors, c\'est quoi un jeton ?'),
      options: [
  ...
  },
  {
    ...
    master: 'writing',
    minutes: 8,
    title: B('An instruction, not a wish', 'Une consigne, pas un souhait'),
    learn: B(
      'You will write an instruction a model follows, not a wish it interprets.',
      "Tu vas écrire une consigne qu'un modèle suit, pas un souhait qu'il interprète.",
    ),
  ...
  },
  {
    ...
    steps: [
      B('Give an example of what good looks like. One example beats a paragraph of instructions.',
        "Donne un exemple de ce qui est bon. Un exemple vaut mieux qu'un paragraphe de consignes."),
  ...
  },
  {
    ...
    learn: B(
      ...
      "Tu vas savoir dire si ton problème demande un agent ou juste une bonne consigne.",
    ),
  ...
  },
  {
    ...
    trap: B(
      ...
      "Raccourcir ton instruction pour économiser des jetons. L'instruction est la partie la moins chère, et celle qui décide de la réponse.",
    ),
    quiz: {
      q: B('Which of these cuts the bill most?',
        'Lequel réduit le plus la facture ?'),
      options: [
        B('Writing shorter instructions on every single request you make', 'Écrire des instructions plus courtes sur chacune de tes demandes'),
      ...
      why: B(
        ...
        "Un cinquantième tour renvoie quarante-neuf tours d'historique. Ton instruction fait quelques lignes ; l'historique, c'est tout le reste.",
      ),
    },
...
const M_START: Level[] = [
  ...
  },
  {
    ...
    learn: B(
      ...
      "Fini de fouiller tes vieilles discussions : un seul endroit pour toutes tes instructions.",
    ),
    act: B('Create one document that holds the instructions you reuse.',
      'Crée un document qui contient les instructions que tu réutilises.'),
    steps: [
    ...
    trap: B(
      ...
      "Garder tes instructions dans l'historique de discussion. Tu ne les retrouveras jamais, et tu les réécriras moins bien.",
    ),
    quiz: {
      q: B('Why keep instructions outside the chat?',
        'Pourquoi garder tes instructions hors de la discussion ?'),
      options: [
      ...
      why: B(
        ...
        "Tout le savoir-faire consiste à améliorer une instruction sur dix passages. Un historique où tu ne peux pas chercher, c'est repartir de mémoire à chaque fois, donc repartir de moins bien.",
      ),
    },
...
const M_BASICS: Level[] = [
  {
    ...
    master: 'writing',
    minutes: 6,
    title: B('One instruction, one job', 'Une instruction, un seul métier'),
    learn: B(
      'You will stop writing instructions that ask for four things at once.',
      "Tu vas arrêter d'écrire des instructions qui demandent quatre choses à la fois.",
    ),
    act: B('Split your longest instruction into the jobs it really contains.',
      'Découpe ta plus longue instruction selon les métiers qu\'elle contient vraiment.'),
    steps: [
      ...
      B('Run the short one. It will beat the long one, and it will surprise you.',
        "Lance la courte. Elle battra la longue, et ça va te surprendre."),
    ],
    trap: B(
    ...
    quiz: {
      q: B('Your instruction asks to research, summarise and write a post. What do you do?',
        'Ton instruction demande d\'étudier, de résumer et de rédiger une publication. Tu fais quoi ?'),
      options: [
      ...
      why: B(
        ...
        "Trois métiers dans une instruction reçoivent chacun un tiers de l'attention. Trois à la suite la reçoivent entière, et tu peux corriger celui qui a raté.",
      ),
    },
...
const M_ELEMENTS: Level[] = [
  ...
  },
  {
    ...
    act: B('Replace half your instructions with one worked example.',
      'Remplace la moitié de tes consignes par un exemple travaillé.'),
    steps: [
    ...
    trap: B(
      ...
      "Donner seulement un exemple de ce que tu ne veux PAS. Il marque plus que la consigne qui l'interdit.",
    ),
    quiz: {
  ...
  },
  {
    ...
    act: B('Add three bans to your instruction and try to break them.',
      'Ajoute trois interdits à ton instruction et essaie de les faire tomber.'),
    steps: [
  ...
  },
  {
    ...
    steps: [
      ...
      B('Write one new instruction that includes what you learned.',
        "Écris une instruction neuve qui contient ce que tu as appris."),
    ...
    quiz: {
      ...
      why: B(
        ...
        "Chaque correction s'ajoute à un historique que le modèle relit, y compris les trois mauvaises réponses. L'instruction que tu écrirais maintenant est meilleure que celle de départ.",
      ),
    },
...
const M_MODELS: Level[] = [
  ...
  },
  {
    ...
    master: 'tools',
    minutes: 6,
    title: B('Never get locked into one provider', 'Ne sois plus prisonnier d\'un fournisseur'),
    learn: B(
    ...
    act: B('Take one instruction and run it on a second provider unchanged.',
      'Prends une instruction et lance-la telle quelle chez un second fournisseur.'),
    steps: [
      B('Your instruction is portable. It is plain text and it always was.',
        "Ton instruction est portable. C'est du texte simple, et elle l'a toujours été."),
      ...
      B('Keep the instruction outside the tool and switching costs you an afternoon.',
        "Garde l'instruction hors de l'outil et changer te coûte une après-midi."),
    ],
    trap: B(
      'Writing instructions that name the tool. "As ChatGPT, ..." stops working the day you leave.',
      "Écrire des instructions qui nomment l'outil. « En tant que ChatGPT, … » cesse de marcher le jour où tu pars.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "L'instruction est le travail. Les conversations n'en sont que le résidu, et un réglage propre à un fournisseur est une cage que tu t'es construite.",
      ),
    },
  ...
  },
  {
    ...
    quiz: {
      ...
      why: B(
        ...
        "Le texte sert une fois. Les règles marchent chez tous les fournisseurs, sur tous les textes à venir, et tu peux les corriger à la main.",
      ),
    },
...
const M_GEMINI: Level[] = [
  ...
  },
  {
    ...
    master: 'triage',
    minutes: 6,
    title: B('Three hundred rows, one instruction', 'Trois cents lignes, une seule consigne'),
    learn: B(
      'You will run one instruction over a whole table instead of one row.',
      "Tu vas faire tourner une instruction sur un tableau entier au lieu d'une ligne.",
    ),
    ...
    steps: [
      B('Write the instruction for one row until it is right.',
        "Écris l'instruction pour une ligne jusqu'à ce qu'elle soit juste."),
      B('Test it on ten rows you already know the answer to.',
        "Éprouve-la sur dix lignes dont tu connais déjà la réponse."),
    ...
    quiz: {
      ...
      options: [
        ...
        B('Test it on ten rows whose answer you know', 'La tester sur dix lignes dont tu sais la réponse'),
...
const M_COPILOT: Level[] = [
  {
    ...
    quiz: {
      ...
      why: B(
        ...
        "Un assistant intégré à un outil traite ce qui est ouvert comme ce que tu vises. Maîtriser la fenêtre, c'est maîtriser la consigne.",
      ),
    },
...
const M_COST: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas savoir où partent vraiment tes jetons. Jamais là où tu crois.",
    ),
    act: B('Count the pieces of one real run: instruction, context, history, answer.',
      'Compte les morceaux d\'un passage réel : instruction, contexte, historique, réponse.'),
    steps: [
    ...
    quiz: {
      ...
      options: [
        ...
        B('Your instruction, sent each turn', 'Ton instruction, envoyée à chaque tour'),
      ...
      why: B(
        ...
        "Ton instruction est envoyée une fois par tour et fait quelques lignes. L'historique est envoyé une fois par tour lui aussi, et il grossit de tous les tours précédents.",
      ),
    },
  ...
  },
  {
    ...
    steps: [
      B('Your instruction and your tool schemas are the whole of it. Both are text.',
        "Ton instruction et tes schémas d'outils sont tout. Les deux sont du texte."),
      B('Put a ceiling on what the provider may bill you, before the first run.',
        "Pose un plafond sur ce que le fournisseur peut te facturer, avant le premier passage."),
