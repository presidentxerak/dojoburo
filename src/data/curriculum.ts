...
const DISCOVERY: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas comprendre les mots de base de l'IA, ceux que tout le monde emploie autour de toi sans jamais les expliquer.",
    ),
    act: B('Write each word down and explain it in one sentence, in your own words.',
      'Écris chaque mot et explique-le en une phrase, avec tes propres mots.'),
    steps: [
      B('A model (or LLM) is a program that writes text by predicting the next word. That is all it does.',
        "Un modèle, ou LLM, est un programme qui écrit du texte en prédisant le mot suivant. C'est tout ce qu'il fait."),
      B('A token is a small piece of a word. You pay for the number of tokens, not per answer.',
        'Un token est un petit morceau de mot. Tu paies au nombre de tokens, pas à la réponse.'),
      B('A prompt is your written request. The context is everything sent with it. The context window is what it can read at once.',
        "Un prompt est ta demande écrite. Le contexte, c'est tout ce qui part avec. La context window, c'est ce qu'il peut lire d'un coup."),
      B('An agent is a model with a job, a method and tools. That is what makes it more than a simple chat.',
        "Un agent, c'est un modèle avec un métier, une méthode et des outils. C'est ce qui le distingue d'une simple discussion."),
    ],
    trap: B(
      'Pretending to understand a word you do not know. It comes back in the day four lesson, and you will be lost.',
      'Faire semblant de comprendre un mot. Il revient dans la leçon du jour quatre, et tu seras perdu.',
    ),
    quiz: {
  ...
  },
  {
    ...
    learn: B(
      ...
      "Tu te fais encore piéger par des réponses fausses ? Découvre les quatre erreurs classiques d'un modèle.",
    ),
    act: B('Ask a model a question you already know the answer to, and look for its mistakes.',
      'Pose à un modèle une question dont tu connais la réponse, et cherche ses erreurs.'),
    steps: [
      ...
      B('It tends to agree with you. Ask it to defend the opposite view: it will often switch sides.',
        "Il a tendance à te donner raison. Demande-lui de défendre l'avis contraire : il changera souvent de camp."),
    ...
    trap: B(
      ...
      "Croire une réponse parce qu'elle a l'air sûre d'elle. Un modèle parle avec la même assurance quand il se trompe.",
    ),
    quiz: {
      ...
      why: B(
        ...
        'Les références inventées sont souvent très détaillées, car les détails les rendent crédibles. Demander au modèle ne sert à rien : il te dira oui.',
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu utilises un seul outil pour tout ? Tu vas apprendre lequel choisir pour chaque type de travail.',
    ),
    ...
    steps: [
      B('To think things through, write or rewrite: use a chat assistant.',
        'Pour réfléchir, écrire ou réécrire : prends un assistant conversationnel.'),
      B('For a question that needs recent sources: use a search assistant that cites them.',
        'Pour une question qui demande des sources récentes : prends un assistant de recherche qui les cite.'),
      B('For work inside your documents and emails: use an assistant connected to them.',
        'Pour travailler dans tes documents et tes mails : prends un assistant connecté à ces outils.'),
      B('For a job you repeat every week: build an agent. That is what the paid path teaches.',
        "Pour un travail que tu refais chaque semaine : construis un agent. C'est ce qu'enseigne le parcours payant."),
    ],
    trap: B(
      'Picking the tool everyone talks about instead of the one that fits your task. They are rarely the same.',
      "Choisir l'outil à la mode plutôt que celui qui convient à ta tâche. Ce sont rarement les mêmes.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Un assistant conversationnel répond avec ce qu'il a appris à l'entraînement. Ce savoir s'arrête à une date et n'a pas de sources. Pour des chiffres récents, il faut un outil qui cherche et montre où.",
      ),
    },
  ...
  },
  {
    ...
    master: 'writing',
    minutes: 8,
    title: B('Write a prompt it can follow', "Écris un prompt qu'il peut suivre"),
    learn: B(
      'You will write a precise request the model follows, instead of a vague wish it has to guess.',
      "Tu vas écrire une demande précise que le modèle suit, au lieu d'un souhait vague qu'il doit deviner.",
    ),
    act: B('Rewrite your last request with the four parts below, then run both versions and compare.',
      'Réécris ta dernière demande avec les quatre parties ci-dessous, puis lance les deux versions et compare.'),
    steps: [
      B('The outcome: describe in concrete terms what you want to get at the end.',
        'Le résultat : décris concrètement ce que tu veux obtenir à la fin.'),
      B('The audience: say who will read it. It changes how everything is written.',
        'Le public : dis qui va lire. Ça change la façon dont tout est écrit.'),
      ...
      B('The test: decide in advance how you will check that the result is good.',
        "Le critère : décide à l'avance comment tu vérifieras que le résultat est bon."),
    ],
    trap: B(
      'Adding "be creative" or "be professional". These words are too vague: the model cannot turn them into anything precise.',
      'Ajouter « sois créatif » ou « sois professionnel ». Ces mots sont trop vagues : le modèle ne sait pas quoi en faire.',
    ),
    quiz: {
      q: B('Which of these is a precise request rather than a wish?',
        'Laquelle est une demande précise, et pas un simple souhait ?'),
      options: [
      ...
      why: B(
        ...
        "Elle donne la longueur, le lecteur, ce qui vient en premier et ce qu'il faut éviter. Les deux autres peuvent vouloir dire cinquante choses, alors le modèle doit deviner.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas apprendre quatre gestes qui améliorent une réponse plus que reformuler ta demande.',
    ),
    act: B('Take an answer you did not like and try two of these four moves on it.',
      "Reprends une réponse qui ne t'a pas plu et essaie deux de ces quatre gestes."),
    steps: [
      B('Show an example of the result you want. One example works better than a paragraph of instructions.',
        "Montre un exemple du résultat que tu veux. Un exemple marche mieux qu'un paragraphe d'instructions."),
      B('Ask for the plan first. Fix the plan, then ask for the text.',
        "Demande d'abord le plan. Corrige-le, puis demande le texte."),
      B('Ask it to point out what it is unsure about. That is often where the mistakes are.',
        "Demande-lui de signaler ce dont il n'est pas sûr. C'est souvent là que sont les erreurs."),
      B('After a few failed fixes, open a new conversation. The old one keeps its mistakes in view and repeats them.',
        "Après quelques corrections ratées, ouvre une nouvelle conversation. L'ancienne garde ses erreurs sous les yeux et les répète."),
    ],
    trap: B(
      ...
      "Ajouter toujours plus d'adjectifs à la même demande. Au dixième essai, la réponse est pire qu'au premier et a coûté dix fois plus.",
    ),
    quiz: {
      ...
      why: B(
        ...
        'Un ton est difficile à décrire, mais facile à montrer. Deux vrais exemples en font plus que dix adjectifs.',
      ),
    },
  ...
  },
  {
    ...
    act: B('Take a task you repeat every week and describe, in four parts, the agent that would do it.',
      "Prends une tâche que tu refais chaque semaine et décris en quatre parties l'agent qui la ferait."),
    steps: [
      B('A job: the one thing it is responsible for, written in one sentence.',
        'Un métier : la seule chose dont il est responsable, écrite en une phrase.'),
      ...
      B('Tools: the two or three it is allowed to use, not nine.',
        "Des outils : les deux ou trois qu'il a le droit d'utiliser, pas neuf."),
      B('Limits: the rules it keeps even when someone asks it to break them.',
        "Des limites : les règles qu'il respecte même quand on lui demande de les enfreindre."),
    ],
    trap: B(
      'Building an agent for a task you do twice a year. Setting it up takes longer than doing the task yourself.',
      'Construire un agent pour une tâche que tu fais deux fois par an. Le mettre en place prend plus de temps que faire la tâche.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Un agent, c'est une méthode que tu écris une fois. L'effort est rentable dès la deuxième utilisation. Une tâche difficile faite une seule fois demande juste un bon prompt.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      "Tu vas savoir estimer ta facture à l'avance, et quel geste la fait le plus baisser.",
    ),
    act: B('Estimate what one week of your usage would cost.',
      'Estime ce que coûterait une semaine de ton usage.'),
    steps: [
      B('Each new message resends the whole conversation. So you pay for a long conversation again at every turn.',
        'Chaque nouveau message renvoie toute la conversation. Une longue conversation se paie donc à nouveau à chaque tour.'),
      B('Tools you switch on are sent with every step, even when they are not used.',
        'Les outils activés sont envoyés à chaque étape, même quand ils ne servent pas.'),
      B('The biggest model is rarely the right one. Pick a model that fits how hard the task is.',
        'Le plus gros modèle est rarement le bon. Choisis un modèle adapté à la difficulté de la tâche.'),
      B('Measure before you cut. Most people try to save on the part that costs almost nothing.',
        'Mesure avant de couper. La plupart des gens économisent sur la partie qui ne coûte presque rien.'),
    ],
    trap: B(
      'Shortening your prompt to save tokens. It is the cheapest part, and it is what decides the quality of the answer.',
      "Raccourcir ton prompt pour économiser des tokens. C'est la partie la moins chère, et c'est elle qui décide de la qualité de la réponse.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Au cinquantième tour, les quarante-neuf tours précédents sont renvoyés. Ton prompt ne fait que quelques lignes : l'historique pèse bien plus lourd.",
      ),
    },
...
const M_START: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu perds des heures sur la même tâche chaque semaine ? Choisis-la maintenant : tu vas t'entraîner dessus pendant tout le parcours.",
    ),
    ...
    steps: [
      B('Pick something you do at least once a week. A rare task gives you too few chances to practise.',
        "Choisis une tâche que tu fais au moins une fois par semaine. Une tâche rare te laisse trop peu d'occasions de t'entraîner."),
      B('Describe what you have in hand when it is done: a file, a message, a decision.',
        'Décris ce que tu obtiens quand elle est finie : un fichier, un message, une décision.'),
      B('Note how long it takes you today. You will compare at the end of the course.',
        "Note combien de temps elle te prend aujourd'hui. Tu compareras à la fin du parcours."),
    ],
    trap: B(
      'Choosing an impressive task instead of a frequent one. You learn by repeating, so pick the one you do often.',
      "Choisir une tâche impressionnante plutôt qu'une tâche fréquente. On apprend en répétant : prends celle que tu fais souvent.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Une tâche hebdomadaire te donne dix occasions de tester ce que tu apprends. Une tâche difficile t'en donne une seule, et un seul essai ne distingue pas la chance du savoir-faire.",
      ),
    },
  ...
  },
  {
    ...
    master: 'tools',
    minutes: 6,
    title: B('Keep your prompts in one place', 'Range tes prompts au même endroit'),
    learn: B(
    ...
    steps: [
      B('Use a single plain text file. Not a folder, not an app: just one file.',
        'Utilise un seul fichier en texte simple. Pas un dossier, pas une appli : un fichier.'),
      B('Give each prompt its own heading, with the date you last changed it.',
        'Donne à chaque prompt son propre titre, avec la date de sa dernière modification.'),
      B('Under each prompt, paste the result you got, good or bad.',
        'Sous chaque prompt, colle le résultat obtenu, bon ou mauvais.'),
    ],
    trap: B(
      'Leaving your prompts in the chat history. You will not find them again, and you will rewrite them less well.',
      "Laisser tes prompts dans l'historique des discussions. Tu ne les retrouveras pas, et tu les réécriras moins bien.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Tout l'art consiste à améliorer un même prompt sur dix essais. Si tu ne le retrouves pas, tu le réécris de mémoire à chaque fois, et il sort moins bien.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas juger une réponse avec trois questions rapides, au lieu de te fier à ton impression.',
    ),
    act: B('Check your last three AI answers with the three questions below.',
      "Vérifie tes trois dernières réponses d'IA avec les trois questions ci-dessous."),
    steps: [
      B('Would you sign it as it is? If not, name the one thing that stops you.',
        "La signerais-tu telle quelle ? Sinon, nomme ce qui t'en empêche."),
      B('Is there anything in it you cannot check? Highlight it.',
        'Contient-elle des choses que tu ne peux pas vérifier ? Surligne-les.'),
      B('Does it answer the question you asked, or a slightly different one?',
        'Répond-elle à ta question, ou à une question un peu différente ?'),
    ],
    trap: B(
    ...
    quiz: {
      q: B('An answer is well written but misses the point. Where does the problem come from?',
        "Une réponse est bien écrite mais passe à côté du sujet. D'où vient le problème ?"),
      options: [
      ...
      why: B(
        ...
        "Un modèle répond à la question qu'on lui pose. Si la réponse est soignée mais hors sujet, c'est sans doute ton prompt qui visait à côté.",
      ),
    },
...
const M_BASICS: Level[] = [
  {
    ...
    act: B('Split your longest prompt into the separate tasks it contains.',
      "Découpe ton plus long prompt en autant de tâches qu'il en contient."),
    steps: [
      B('Underline every verb that asks for something. Each one is a separate task.',
        'Souligne chaque verbe qui demande quelque chose. Chacun correspond à une tâche.'),
      B('Keep the most important task. Move each of the others into its own prompt.',
        'Garde la tâche la plus importante. Mets chacune des autres dans un prompt à part.'),
      B('Run the short prompt. You will often get a better result than with the long one.',
        "Lance le prompt court. Tu obtiendras souvent un meilleur résultat qu'avec le long."),
    ],
    trap: B(
      'Thinking a longer prompt is more precise. The more you ask at once, the less attention each request gets.',
      "Croire qu'un prompt plus long est plus précis. Plus tu demandes de choses à la fois, moins chacune reçoit d'attention.",
    ),
    quiz: {
      q: B('Your prompt asks it to research, summarise and write a post. What do you do?',
        'Ton prompt demande de chercher, de résumer et de rédiger une publication. Tu fais quoi ?'),
      options: [
      ...
      why: B(
        ...
        "Avec trois tâches dans un prompt, chacune reçoit un tiers de l'attention. Avec trois prompts à la suite, chacune la reçoit entière, et tu peux corriger celle qui a raté.",
      ),
    },
  ...
  },
  {
    ...
    master: 'extraction',
    minutes: 7,
    title: B('Send less, get better answers', 'Envoie moins, obtiens de meilleures réponses'),
    learn: B(
    ...
    steps: [
      ...
      B('Send only that, and say which document it comes from.',
        'Envoie seulement ça, et précise de quel document ça vient.'),
      B('If the answer is still wrong, add one more passage. Never the whole document.',
        'Si la réponse reste fausse, ajoute un passage de plus. Jamais le document entier.'),
    ],
    trap: B(
      'Pasting the whole document so nothing is missing. The important part gets lost in the rest.',
      'Coller tout le document pour ne rien oublier. La partie importante se perd dans le reste.',
    ),
    quiz: {
    ...
    badge: B('Sends just what is needed', "Envoie juste ce qu'il faut"),
  },
  {
    id: 'shape',
    master: 'triage',
    minutes: 6,
    title: B('Choose the format of the answer', 'Choisis le format de la réponse'),
    learn: B(
      'Tired of reformatting answers? Get answers you can use as they are.',
      'Tu passes ton temps à remettre en forme les réponses ? Obtiens-les directement utilisables.',
    ),
    act: B('Ask the same question twice: once with no format, once with a format you choose.',
      'Pose deux fois la même question : une fois sans format, une fois en imposant un format.'),
    steps: [
      B('Name the format: a table, five bullet points, one paragraph, a list of pairs.',
        'Nomme le format : un tableau, cinq puces, un paragraphe, une liste de paires.'),
      B('Name the columns or fields. If you stay vague, it will fill them in vaguely.',
        'Nomme les colonnes ou les champs. Si tu restes vague, il les remplira vaguement.'),
      B('Say what to write when a piece of information is missing. Otherwise it will make something up.',
        'Dis quoi écrire quand une information manque. Sinon, il en inventera une.'),
    ],
    trap: B(
      'Asking for a table without saying what to put in an empty cell. It will fill it with something believable but invented.',
      'Demander un tableau sans dire quoi mettre dans une case vide. Il la remplira avec une info crédible mais inventée.',
    ),
    quiz: {
      ...
      why: B(
        ...
        'Pour un modèle, une case vide ressemble à une erreur, alors il la remplit. Si tu lui dis quoi écrire à la place, tu obtiens un tableau fiable.',
      ),
    },
...
const M_ELEMENTS: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas donner au modèle un rôle précis, pour qu'il réponde avec le bon point de vue.",
    ),
    act: B('Ask the same question with two different roles and compare the answers.',
      'Pose la même question avec deux rôles différents et compare les réponses.'),
    steps: [
      ...
      B('Say what it must refuse to do. Most people forget this part.',
        "Dis ce qu'il doit refuser de faire. C'est la partie que presque tout le monde oublie."),
    ],
    trap: B(
      'Piling up flattering titles. "World-class senior expert" tells the model nothing more than "a tax lawyer".',
      "Empiler les titres flatteurs. « Expert senior de classe mondiale » n'en dit pas plus au modèle que « un fiscaliste ».",
    ),
    quiz: {
  ...
  },
  {
    ...
    act: B('Replace part of your instructions with one concrete example of what you want.',
      'Remplace une partie de tes instructions par un exemple concret de ce que tu veux.'),
    steps: [
      B('Take a result you were happy with and paste it in full.',
        "Prends un résultat qui t'a plu et colle-le en entier."),
      B('Say in one line what makes it good. That line becomes your rule.',
        'Dis en une ligne ce qui le rend bon. Cette ligne devient ta règle.'),
      B('Two examples work better than one. A third rarely adds much.',
        "Deux exemples marchent mieux qu'un. Un troisième apporte rarement plus."),
    ],
    trap: B(
      'Only showing an example of what you do NOT want. The model tends to copy it, even if you tell it not to.',
      'Montrer seulement un exemple de ce que tu ne veux PAS. Le modèle a tendance à le copier, même si tu le lui interdis.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Un ton est un style à reproduire. Un modèle le copie bien plus fidèlement à partir d'un exemple qu'à partir d'adjectifs.",
      ),
    },
  ...
  },
  {
    ...
    master: 'watch',
    minutes: 6,
    title: B('Set limits it will respect', "Pose des limites qu'il respecte"),
    learn: B(
      'You will write limits the model really sticks to, not limits it works around.',
      "Tu vas écrire des limites que le modèle respecte vraiment, pas des limites qu'il contourne.",
    ),
    act: B('Add three bans to your prompt, then try to push the model into breaking them.',
      'Ajoute trois interdits à ton prompt, puis essaie de pousser le modèle à les enfreindre.'),
    steps: [
      B('Ban invention first. Write: "If you do not know, say so."',
        "Interdis d'abord l'invention. Écris : « Si tu ne sais pas, dis-le. »"),
      B('Ban the formats you never want, such as a wall of bullet points or an apology at the start.',
        'Interdis les formats dont tu ne veux jamais, comme un mur de puces ou des excuses en début de réponse.'),
      B('Write bans with no exceptions. If you add one, the model treats the ban as optional.',
        "Écris des interdits sans exception. Si tu en ajoutes une, le modèle traite l'interdit comme facultatif."),
    ],
    trap: B(
    ...
    quiz: {
      ...
      why: B(
        ...
        "Il est sans exception et facile à vérifier : soit tu as fourni la source, soit non. Les deux autres laissent une marge d'appréciation, et c'est par là que l'invention entre.",
      ),
    },
...
const M_TECHNIQUES: Level[] = [
  {
    ...
    steps: [
      B('Ask for the outline only. Tell it not to write the text yet.',
        'Demande seulement le plan. Précise-lui de ne pas encore écrire le texte.'),
      B('Fix the order and add what is missing. It takes two minutes.',
        "Corrige l'ordre et ajoute ce qui manque. Ça prend deux minutes."),
      B('Then ask for the text, following that corrected plan.',
        'Demande ensuite le texte, en suivant ce plan corrigé.'),
    ],
    trap: B(
      'Approving a plan without reading it because it looks well organised. A tidy plan can still be wrong.',
      "Valider un plan sans le lire parce qu'il a l'air bien structuré. Un plan propre peut quand même être faux.",
    ),
    quiz: {
      q: B('Why ask for the plan first?', 'Pourquoi demander le plan d\'abord ?'),
      options: [
        B('A wrong plan is quick to fix, a wrong draft is not',
          'Un plan faux se corrige vite, un brouillon faux non'),
      ...
      why: B(
        ...
        "Chaque erreur du plan se retrouve dans tout le texte. La repérer quand le plan fait cinq lignes t'évite de réécrire deux pages.",
      ),
    },
  ...
  },
  {
    ...
    steps: [
      B('Ask it to rate its confidence next to each claim.',
        'Demande-lui de noter sa confiance à côté de chaque affirmation.'),
      B('Ask what would change its answer. The reply shows what it is assuming.',
        "Demande ce qui changerait sa réponse. Ça révèle les hypothèses qu'il a faites."),
      B('Check the two claims with the lowest confidence. That is where errors usually hide.',
        "Vérifie les deux affirmations les moins sûres. C'est là que se cachent le plus souvent les erreurs."),
    ],
    trap: B(
      'Asking "are you sure?". It will almost always say yes, because a model tends to agree.',
      "Demander « tu es sûr ? ». Il répondra presque toujours oui, parce qu'un modèle a tendance à acquiescer.",
    ),
    quiz: {
      ...
      why: B(
        ...
        'Une question fermée obtient un oui. Un classement oblige le modèle à comparer, et le bas du classement te montre quoi vérifier.',
      ),
    },
  ...
  },
  {
    ...
    master: 'triage',
    minutes: 5,
    title: B('Know when to start over', 'Sache quand repartir de zéro'),
    learn: B(
    ...
    act: B('Take a conversation that went wrong and restate your request in one new message.',
      'Prends une conversation qui a dérapé et reformule ta demande en un seul message neuf.'),
    steps: [
      ...
      B('Write a new prompt that includes what you learned from the failed tries.',
        'Écris un nouveau prompt qui tient compte de ce que tu as appris des essais ratés.'),
      B('Paste it into a new conversation. The old one is cluttered with the wrong answers.',
        "Colle-le dans une nouvelle conversation. L'ancienne est encombrée par les mauvaises réponses."),
    ],
    trap: B(
      'Correcting a tenth time because you already spent nine tries. The old answers in the history keep pulling it off course.',
      "Corriger une dixième fois parce que tu as déjà fait neuf essais. Les vieilles réponses de l'historique continuent de le faire dévier.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "À chaque tour, le modèle relit tout l'historique, y compris les trois mauvaises réponses. Et le prompt que tu écrirais maintenant est meilleur que le premier.",
      ),
    },
...
const M_MODELS: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas choisir un modèle pour ce qu'il sait faire, pas pour ce qu'en disent les annonces.",
    ),
    ...
    steps: [
      B('Context window: how much it can read at once. It limits what you can send it.',
        "La context window : ce qu'il peut lire en une fois. Elle limite ce que tu peux lui envoyer."),
      B('Reasoning: whether it thinks before answering. Slower, but better on hard problems.',
        "Le raisonnement : s'il réfléchit avant de répondre. C'est plus lent, mais meilleur sur les problèmes difficiles."),
      B('Price: what it costs per million tokens sent and received. Output tokens always cost more.',
        "Le prix : ce qu'il coûte par million de tokens envoyés et reçus. Les tokens de sortie coûtent toujours plus cher."),
    ],
    trap: B(
      'Picking the newest model by default. On an easy task, it costs more and does no better.',
      'Prendre le modèle le plus récent par défaut. Sur une tâche facile, il coûte plus cher et ne fait pas mieux.',
    ),
    quiz: {
      ...
      why: B(
        ...
        'Trier en quatre catégories nommées est une tâche facile, répétée trois cents fois. Le prompt décide de la justesse, la taille du modèle décide de la facture.',
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas activer la réflexion profonde seulement pour les tâches qui en ont besoin.',
    ),
    act: B('Run the same task twice, with and without deep thinking, then compare time and result.',
      'Lance la même tâche deux fois, avec et sans réflexion profonde, puis compare le temps et le résultat.'),
    steps: [
      B('It helps on tasks with several steps to chain: calculations, code, a plan.',
        'Elle aide sur les tâches à plusieurs étapes : calculs, code, plan.'),
      B('It does not help with a simple lookup or a rewrite.',
        "Elle n'aide pas pour une simple recherche ou une réécriture."),
      B('It is billed. You pay for this thinking even if you never see it.',
        'Elle est facturée. Tu paies cette réflexion même si tu ne la vois jamais.'),
    ],
    trap: B(
      'Leaving it on for everything. You pay three to five times more for the same answers.',
      'La laisser activée pour tout. Tu paies trois à cinq fois plus pour les mêmes réponses.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "La réflexion profonde sert quand il y a plusieurs étapes à enchaîner. Une réécriture n'en a qu'une. Tu paierais un raisonnement qui n'a rien à traiter.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas garder ton travail portable, pour pouvoir changer de provider facilement.',
    ),
    act: B('Take one prompt and run it unchanged with another provider.',
      'Prends un prompt et lance-le tel quel chez un autre provider.'),
    steps: [
      B('Your prompt is plain text, so you can use it with any provider.',
        "Ton prompt est du texte simple : tu peux l'utiliser chez n'importe quel provider."),
      B('What does not move easily is the technical setup: tool formats, file handling.',
        "Ce qui ne se déplace pas facilement, c'est la partie technique : formats d'outils, gestion des fichiers."),
      B('Keep your prompts in your own file, outside the tool. Then switching provider takes an afternoon.',
        "Garde tes prompts dans ton propre fichier, hors de l'outil. Changer de provider te prendra alors une après-midi."),
    ],
    trap: B(
      'Writing prompts that mention the tool by name. "As ChatGPT, ..." stops working the day you switch.',
      "Écrire des prompts qui citent le nom de l'outil. « En tant que ChatGPT, … » ne marche plus le jour où tu changes.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Le prompt, c'est ton vrai travail. Les conversations n'en sont que les restes. Un réglage lié à un seul provider t'enferme chez lui.",
      ),
    },
...
const M_CHATGPT: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas contrôler ce qu'il retient d'une conversation à l'autre, au lieu de deviner.",
    ),
    act: B('Read what it has saved about you, and delete what is wrong or out of date.',
      "Lis ce qu'il a enregistré sur toi, et supprime ce qui est faux ou dépassé."),
    steps: [
      B('It keeps notes about you from one chat to the next. Useful, but you only see them if you go and read them.',
        "Il garde des notes sur toi d'une discussion à l'autre. C'est utile, mais tu ne les vois que si tu vas les lire."),
      B('Those notes influence every new answer. A wrong note is worse than no note.',
        'Ces notes influencent chaque nouvelle réponse. Une note fausse est pire que pas de note.'),
      B('Custom instructions apply to every conversation. Keep them short and general.',
        "Les instructions permanentes s'appliquent à toutes les conversations. Garde-les courtes et générales."),
    ],
    trap: B(
    ...
    quiz: {
      ...
      why: B(
        ...
        'Quand les réponses sont à côté depuis des semaines, sur des questions différentes, la cause est envoyée avec chaque question. Ce sont les notes enregistrées.',
      ),
    },
  ...
  },
  {
    ...
    act: B('Create a project for one recurring piece of work, with its files.',
      'Crée un projet pour un travail récurrent, avec ses fichiers.'),
    steps: [
      B('Create one project per recurring job, not one per week.',
        'Crée un projet par travail récurrent, pas un par semaine.'),
      B('Store its instructions in the project itself, not in your first message.',
        'Enregistre ses instructions dans le projet lui-même, pas dans ton premier message.'),
      B('Add its reference files to the project too, instead of pasting them into each prompt.',
        'Ajoute aussi ses fichiers de référence au projet, au lieu de les coller dans chaque prompt.'),
    ],
    trap: B(
      'Creating a project for every topic you have ever touched. Thirty projects is a mess, not a method.',
      "Créer un projet pour chaque sujet abordé. Trente projets, c'est du désordre, pas une méthode.",
    ),
    quiz: {
      q: B('What belongs in a project rather than in a message?',
        "Qu'est-ce qui va dans un projet plutôt que dans un message ?"),
      options: [
      ...
      why: B(
        ...
        'Si le contexte ne change jamais, le retaper fait perdre du temps, et tu le retaperas un peu différemment. Un projet le garde une fois pour toutes.',
      ),
    },
    badge: B('Sets the context once', 'Pose le contexte une fois'),
  },
  {
    id: 'gpt-files',
    master: 'extraction',
    ...
    learn: B(
      ...
      'Tu vas savoir quand un fichier est lu en entier, et quand seuls certains extraits sont lus.',
    ),
    ...
    steps: [
      B('A short file is read in full. A long file is searched, and only some passages are read.',
        'Un fichier court est lu en entier. Un fichier long est fouillé, et seuls certains extraits sont lus.'),
      B('So it can miss a link between two pages that are far apart.',
        'Il peut donc rater un lien entre deux pages éloignées.'),
      B('When that link matters, paste both passages yourself.',
        'Quand ce lien compte, colle toi-même les deux passages.'),
    ],
    trap: B(
      'Asking for a summary of a long document and trusting it. It only saw some passages, not the whole thing.',
      "Demander le résumé d'un long document et s'y fier. Il n'en a vu que des extraits, pas l'ensemble.",
    ),
    quiz: {
      ...
      why: B(
        ...
        'Pour trouver une contradiction, il doit voir les deux passages en même temps. Une recherche ramène les passages proches de tes mots, pas les deux qui se contredisent.',
      ),
    },
...
const M_CLAUDE: Level[] = [
  {
    ...
    learn: B(
      ...
      'Tu vas utiliser une grande context window pour comparer des documents, pas juste pour en mettre plus.',
    ),
    ...
    steps: [
      B('A large context window lets it read several documents at once, so it can compare them.',
        'Une grande context window lui permet de lire plusieurs documents à la fois, donc de les comparer.'),
      B('Before pasting each document, say what it is. A clear label works better than relying on the order.',
        "Avant de coller chaque document, dis ce que c'est. Une étiquette claire marche mieux que l'ordre."),
      B('Ask for the differences, not a summary. A summary hides where they disagree.',
        'Demande les différences, pas un résumé. Un résumé cache les points de désaccord.'),
    ],
    trap: B(
      'Filling the context window just because there is room. Everything you add can pull the answer off course.',
      "Remplir la context window juste parce qu'il reste de la place. Chaque ajout peut faire dévier la réponse.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Trois résumés te disent seulement ce que contient chaque devis. L'intérêt de les lire ensemble, c'est de repérer ce qui n'apparaît qu'en les comparant.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas repartir avec un document que tu peux continuer à améliorer, pas une longue discussion.',
    ),
    act: B('Ask for one complete document, then change just one part of it.',
      'Demande un document complet, puis modifies-en une seule partie.'),
    steps: [
      B('Ask for the document alone, without explanations around it.',
        'Demande le document seul, sans explications autour.'),
      B('To change a part, name it. Do not describe the whole document again.',
        'Pour changer une partie, nomme-la. Ne redécris pas tout le document.'),
      B('Save the final version outside the conversation.',
        'Enregistre la version finale en dehors de la conversation.'),
    ],
    trap: B(
      'Asking for the whole document again to change one line. You get a new version, slightly different everywhere.',
      'Redemander tout le document pour changer une ligne. Tu obtiens une nouvelle version, un peu différente partout.',
    ),
    quiz: {
      ...
      why: B(
        ...
        'Une réécriture complète modifie des parties que tu avais validées, sans te dire lesquelles. Nommer la partie à changer garde le reste intact.',
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Marre du ton passe-partout ? Tu vas lui faire écrire avec ta propre voix.',
    ),
    act: B('Give it three texts you wrote and ask it to list your writing rules.',
      "Donne-lui trois textes que tu as écrits et demande-lui de lister tes règles d'écriture."),
    steps: [
      B('Paste three real texts. Not your best ones, your everyday ones.',
        'Colle trois vrais textes. Pas tes meilleurs, ceux de tous les jours.'),
      B('Ask it to list the writing rules it notices. Correct that list.',
        "Demande-lui de lister les règles d'écriture qu'il repère. Corrige cette liste."),
      B('Keep the corrected list. It is your style guide, and it works with any tool.',
        "Garde la liste corrigée. C'est ta charte d'écriture, et elle marche avec n'importe quel outil."),
    ],
    trap: B(
...
const M_GEMINI: Level[] = [
  {
    ...
    learn: B(
      ...
      'Tu recopies encore tes documents dans une discussion ? Tu vas travailler dessus là où ils sont déjà.',
    ),
    ...
    steps: [
      B('An assistant connected to your online storage reads each file where it is kept.',
        'Un assistant connecté à ton espace de stockage en ligne lit chaque fichier là où il est rangé.'),
      B('No copy is needed, so you never work on an outdated version.',
        'Plus besoin de copie, donc tu ne travailles jamais sur une version périmée.'),
      B('But it sees everything you can see. Check who else has access to your files.',
        "Mais il voit tout ce que tu peux voir. Vérifie qui d'autre a accès à tes fichiers."),
    ],
    trap: B(
      'Forgetting that access depends on sharing. A document shared with many people can be found by all their assistants.',
      "Oublier que l'accès dépend du partage. Un document partagé avec beaucoup de monde peut être retrouvé par tous leurs assistants.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Coller crée une deuxième copie, qui devient fausse dès que quelqu'un modifie l'original. Lire le fichier sur place évite ce problème.",
      ),
    },
  ...
  },
  {
    ...
    steps: [
      B('A tool limited to your sources answers only from what you gave it, and shows where.',
        'Un outil limité à tes sources répond seulement avec ce que tu lui as donné, et indique où.'),
      B('Ask a question your documents cannot answer. A good tool will tell you so.',
        'Pose une question à laquelle tes documents ne répondent pas. Un bon outil te le dira.'),
      B('That refusal is exactly what you want. A general chat would answer anyway, with no source.',
        'Ce refus est justement ce que tu cherches. Une discussion classique répondrait quand même, sans source.'),
    ],
    trap: B(
      'Judging it by how much it writes. A short answer with a source is worth more than a long one without.',
      "Le juger à la longueur de ses réponses. Une réponse courte avec une source vaut mieux qu'une longue sans.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "L'intérêt de limiter les réponses à tes sources, c'est de savoir que tout ce qui est dit en vient. Une réponse venue d'ailleurs, même vraie, casse cette garantie sans prévenir.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      "Tu vas appliquer un prompt à tout un tableau, au lieu d'une ligne à la fois.",
    ),
    act: B('Take a spreadsheet column and classify every row in one go.',
      "Prends une colonne de tableur et classe toutes ses lignes d'un coup."),
    steps: [
      B('Work on the prompt for a single row until the result is right.',
        "Travaille le prompt sur une seule ligne jusqu'à ce que le résultat soit juste."),
      B('Test it on ten rows whose answer you already know.',
        'Teste-le sur dix lignes dont tu connais déjà la réponse.'),
      B('Only then run all three hundred. Any error will also be repeated three hundred times.',
        'Seulement ensuite, lance les trois cents. Une erreur sera, elle aussi, répétée trois cents fois.'),
    ],
    trap: B(
      'Running the whole table first "to see what happens". You get three hundred wrong rows and no idea why.',
      "Lancer tout le tableau d'abord « pour voir ». Tu obtiens trois cents lignes fausses sans savoir pourquoi.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Dix lignes dont tu connais la réponse te montrent le taux d'erreur avant de dépenser quoi que ce soit. Sans elles, tu paies trois cents résultats invérifiables.",
      ),
    },
...
const M_PERPLEXITY: Level[] = [
  {
    ...
    learn: B(
      ...
      'Tu vas juger une réponse documentée sur ses sources, pas sur la qualité de sa rédaction.',
    ),
    act: B('Open every source behind one answer and count how many really support it.',
      "Ouvre chaque source d'une réponse et compte combien la confirment vraiment."),
    steps: [
      B('A citation proves the page was read, not that it says what the answer claims.',
        "Une citation prouve que la page a été lue, pas qu'elle dit ce qu'affirme la réponse."),
      B('Check the date on the source page itself, not the date given in the answer.',
        'Vérifie la date sur la page source elle-même, pas celle donnée dans la réponse.'),
    ...
    trap: B(
      ...
      "Prendre le nombre de citations pour une preuve. Dix liens qui viennent tous de la même origine, c'est un seul fait répété dix fois.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Des sources ne s'additionnent que si elles sont indépendantes. Cinq sites qui relaient un communiqué te donnent cinq fois le même texte, sans vérification de plus.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas poser des questions qui ont une réponse précise quelque part, et dire où la chercher.',
    ),
    act: B('Rewrite a vague question so that a wrong answer would be easy to spot.',
      "Réécris une question vague pour qu'une mauvaise réponse soit facile à repérer."),
    steps: [
      B('Give the period. A search cannot guess what "recently" means.',
        'Précise la période. Une recherche ne sait pas ce que veut dire « récemment ».'),
      ...
      B('Ask for the figure and where it comes from, in the same sentence.',
        'Demande le chiffre et sa provenance dans la même phrase.'),
    ],
    trap: B(
    ...
    quiz: {
      q: B('Which question gets an answer you can check?',
        'Quelle question donne une réponse que tu peux vérifier ?'),
      options: [
      ...
      why: B(
        ...
        "Elle donne une année, une quantité et le type de preuve. Les deux autres acceptent des réponses vagues qu'on ne peut ni prouver fausses, ni vérifier.",
      ),
    },
  ...
  },
  {
    ...
    steps: [
      B('Search when the answer may have changed recently, or when you need proof.',
        'Lance une recherche quand la réponse a pu changer récemment, ou quand il te faut une preuve.'),
      B('Do not search to rewrite, to summarise your own text, or to think something through.',
        'Ne lance pas de recherche pour réécrire, résumer ton propre texte ou réfléchir.'),
      B('A search adds pages to read, so it costs more and adds noise to the answer.',
        'Une recherche ajoute des pages à lire : ça coûte plus cher et ça brouille la réponse.'),
    ],
    trap: B(
      ...
      'Laisser la recherche activée pour tout. Quand la réponse ne change pas avec le temps, la recherche la rend juste plus lente, plus chère et moins directe.',
    ),
    quiz: {
      q: B('Rewriting your own paragraph. Should you search?',
        'Réécrire ton propre paragraphe. Faut-il lancer une recherche ?'),
      options: [
      ...
      why: B(
        ...
        "Le texte est déjà là. Une recherche ajoute des pages sur d'autres sujets, qui éloignent la réécriture du tien.",
      ),
    },
    badge: B('Searches only when useful', 'Cherche seulement quand ça sert'),
  },
]
...
const M_COPILOT: Level[] = [
  {
    ...
    learn: B(
      ...
      "Tu vas contrôler ce qu'il utilise en choisissant ce que tu laisses ouvert.",
    ),
    ...
    steps: [
      B('An assistant built into a tool reads whatever the tool has open.',
        "Un assistant intégré à un outil lit tout ce que l'outil a d'ouvert."),
      B('Open files that have nothing to do with your question can steer the answer off course.',
        'Les fichiers ouverts sans rapport avec ta question peuvent faire dévier la réponse.'),
      B('Name the file or sheet you mean, instead of hoping it guesses.',
        "Nomme le fichier ou la feuille que tu vises, au lieu d'espérer qu'il devine."),
    ],
    trap: B(
      'Blaming the model when the answer mixes two projects. You had both open, so it used both.',
      'Accuser le modèle quand la réponse mélange deux projets. Tu avais les deux ouverts, alors il a utilisé les deux.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Un assistant intégré à un outil suppose que ce qui est ouvert est ce dont tu parles. Choisir ce qui est ouvert, c'est choisir le prompt.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Des transcriptions que personne ne lit ? Transforme une réunion en décisions, chacune avec un responsable.',
    ),
    ...
    steps: [
      ...
      B('Also ask what was raised but not settled. That list is often the most useful.',
        "Demande aussi ce qui a été soulevé sans être tranché. C'est souvent la liste la plus utile."),
    ],
    trap: B(
      'Accepting a summary that reads well but names no one. Nothing will get done, and nobody will notice.',
      "Accepter un résumé bien écrit qui ne nomme personne. Rien ne sera fait, et personne ne s'en rendra compte.",
    ),
    quiz: {
  ...
  },
  {
    ...
    act: B('Ask it for something you should not be able to see, to test the access rights.',
      "Demande-lui une chose que tu ne devrais pas pouvoir voir, pour tester les droits d'accès."),
    steps: [
      B('It can open exactly what your account can open. No more, no less.',
        'Il accède exactement à ce que ton compte peut ouvrir. Ni plus, ni moins.'),
      B('So a folder shared too widely can now be found with one simple question.',
        'Donc un dossier partagé trop largement peut être retrouvé avec une simple question.'),
      B('Before rolling it out to everyone, fix the file sharing, not the assistant.',
        "Avant de le déployer pour tout le monde, corrige les partages de fichiers, pas l'assistant."),
    ],
    trap: B(
    ...
    quiz: {
      ...
      why: B(
        ...
        "Il ne lit que ce que ton compte avait déjà le droit d'ouvrir. Il ne t'a pas donné de nouvel accès : il a rendu un accès existant plus facile à utiliser.",
      ),
    },
...
const M_AGENTS: Level[] = [
  {
    ...
    master: 'triage',
    minutes: 7,
    title: B('What type of agent do you need?', "De quel type d'agent as-tu besoin ?"),
    learn: B(
      'You will identify the type of agent before building it, because each type fails in its own way.',
      "Tu vas identifier le type d'agent avant de le construire, parce que chaque type se trompe à sa façon.",
    ),
    act: B('Take your target task and say which of the twelve types it matches.',
      'Prends ta tâche cible et dis auquel des douze types elle correspond.'),
    steps: [
      ...
      B('If your task matches two types, you need two agents. This is the key point of the lesson.',
        "Si ta tâche correspond à deux types, il te faut deux agents. C'est le point clé de cette leçon."),
    ],
    trap: B(
      'Building one agent for a job that is really three. It will do all three badly.',
      'Construire un seul agent pour un travail qui en contient trois. Il fera mal les trois.',
    ),
    quiz: {
      q: B('An agent reads invoices and fills a table. Which type?',
        'Un agent lit des factures et remplit un tableau. Quel type ?'),
      options: [
      ...
      why: B(
        ...
        "Il extrait des champs nommés de documents. Le savoir t'indique tout de suite son erreur typique : une valeur crédible dans un champ qui était vide.",
      ),
    },
  ...
  },
  {
    ...
    act: B('Write four steps for your agent, in order, each one producing something concrete.',
      "Écris quatre étapes pour ton agent, dans l'ordre, chacune produisant quelque chose de concret."),
    steps: [
      ...
      B('A step that only says "think about" or "analyse" produces nothing. Remove it or make it concrete.',
        'Une étape qui dit seulement « étudier » ou « analyser » ne produit rien. Supprime-la ou rends-la concrète.'),
      B('Each step starts from what the previous one produced. Write that down.',
        'Chaque étape part de ce que la précédente a produit. Écris-le noir sur blanc.'),
      B('Aim for four to six steps. Fewer than four usually means several tasks are hidden in one step.',
        "Vise quatre à six étapes. Moins de quatre, c'est souvent que plusieurs tâches se cachent dans une seule."),
    ],
    trap: B(
      'Writing "analyse the data" as a step. It produces nothing, so the next step has nothing to work with.',
      "Écrire « analyser les données » comme étape. Elle ne produit rien, donc l'étape suivante n'a rien sur quoi travailler.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Elle dit ce qui sort et en quelle quantité. Les deux autres ne produisent rien d'utilisable pour l'étape suivante : ce sont des mots creux.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      "Tu vas autoriser les actions de ton agent une par une, pas toutes d'un coup.",
    ),
    ...
    steps: [
      B('Start in read-only mode. You see what the agent tries to do, with no risk.',
        "Commence en lecture seule. Tu vois ce que l'agent essaie de faire, sans aucun risque."),
      B('Then allow one action that changes something, and watch it on a few real cases.',
        'Puis autorise une action qui modifie quelque chose, et observe-la sur quelques cas réels.'),
      B('Require your approval for anything that cannot be undone.',
        'Exige ton accord pour tout ce qui ne peut pas être annulé.'),
      B('What it reads is information, never an order to follow. Write that into its limits.',
        "Ce qu'il lit est une information, jamais un ordre à suivre. Écris-le dans ses limites."),
    ],
    trap: B(
      'Turning on every tool to test faster. When something goes wrong, you cannot tell which tool caused it.',
      'Tout activer pour tester plus vite. Quand ça dérape, tu ne sais pas quel outil en est la cause.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Tout ce qui est lu via un outil est du contenu, pas un ordre. Écrire cette limite noir sur blanc empêche quelqu'un d'utiliser ta propre boîte mail pour piloter ton agent.",
      ),
    },
...
const M_DESIGN: Level[] = [
  {
    ...
    master: 'analysis',
    minutes: 7,
    title: B('Judge a screen, no design skills needed', 'Juge un écran sans être designer'),
    learn: B(
    ...
    steps: [
      B('One element must clearly be the most important. If two compete, the eye does not know where to look.',
        "Un élément doit être clairement le plus important. Si deux se disputent l'attention, l'œil ne sait pas où aller."),
      B('Put things that belong together close to each other, and away from the rest.',
        'Rapproche ce qui va ensemble, et éloigne-le du reste.'),
      B('Use fewer text sizes, font weights and colours than you think you need.',
        'Utilise moins de tailles de texte, de graisses et de couleurs que tu ne le penses.'),
      B('Leave empty space on purpose. It is part of the design, not a gap to fill.',
        "Laisse du vide exprès. Il fait partie du design, ce n'est pas un trou à combler."),
    ],
    trap: B(
      'Adding a colour to fix a hierarchy problem. The real fix is in where elements sit and how they are grouped.',
      'Ajouter une couleur pour régler un problème de hiérarchie. La vraie solution est dans la position et le regroupement des éléments.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Un écran doit guider vers un choix. Avec deux boutons égaux, l'utilisateur doit décider seul, et souvent il n'en choisit aucun et s'en va.",
      ),
    },
  ...
  },
  {
    ...
    act: B('Describe one screen by its structure, not with adjectives, and have it built.',
      'Décris un écran par sa structure, pas avec des adjectifs, et fais-le construire.'),
    steps: [
      B('Say in one sentence what the screen is FOR. Everything else follows from that.',
        "Dis en une phrase à quoi sert l'écran. Tout le reste en découle."),
      B('List the blocks from top to bottom, and say which one matters most.',
        'Liste les blocs de haut en bas, et dis lequel compte le plus.'),
      B('Describe what it shows when things go wrong: no data, loading, text too long.',
        "Décris ce qu'il affiche quand ça se passe mal : aucune donnée, chargement, texte trop long."),
      B('Ask for one screen at a time. Ten at once gives you ten average screens.',
        "Demande un écran à la fois. Dix d'un coup te donnent dix écrans moyens."),
    ],
    trap: B(
      'Asking for "a modern, clean, professional page". You get a page that looks like every other page.',
      'Demander « une page moderne, épurée, professionnelle ». Tu obtiendras une page qui ressemble à toutes les autres.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Par défaut, un modèle dessine le cas où tout va bien. Pourtant, l'écran vide est souvent le premier qu'un vrai utilisateur voit, et personne ne le demande.",
      ),
    },
  ...
  },
  {
    ...
    act: B('Build one page, then change one thing and build it again.',
      'Construis une page, puis changes-y une chose et reconstruis-la.'),
    steps: [
      ...
      B('Change one thing at a time. With two changes, you cannot tell which one broke the page.',
        'Change une chose à la fois. Avec deux changements, tu ne sais pas lequel a cassé la page.'),
      B('Keep your structure document. The generated code can be thrown away and made again.',
        'Garde ton document de structure. Le code généré peut être jeté et refait.'),
    ],
    trap: B(
      'Thinking the generated code is the real work. The real work is your decisions; the code just follows from them.',
      'Croire que le code généré est le vrai travail. Le vrai travail, ce sont tes décisions ; le code en découle.',
    ),
    quiz: {
      ...
      why: B(
        ...
        "Avec de bonnes décisions, tu régénères le code en une minute. Mais le code ne te rend pas les décisions. C'est donc elles que tu gardes.",
      ),
    },
...
const M_COST: Level[] = [
  {
    ...
    learn: B(
      ...
      'Tu vas savoir où partent vraiment tes tokens. Souvent pas là où tu crois.',
    ),
    act: B('Take one real exchange and count the tokens in each part: prompt, context, history, answer.',
      'Prends un échange réel et compte les tokens de chaque partie : prompt, contexte, historique, réponse.'),
    steps: [
      B('You pay for four parts, and they are rarely the same size.',
        'Tu paies pour quatre parties, et elles sont rarement de la même taille.'),
      B('The prompt is almost always the smallest, yet it is the part people cut.',
        "Le prompt est presque toujours la plus petite partie, et c'est pourtant elle qu'on coupe."),
    ...
    trap: B(
      ...
      "Couper ce qui se voit. La partie visible, c'est le prompt, et il ne coûte presque rien.",
    ),
    quiz: {
      ...
      why: B(
        ...
        "Ton prompt fait quelques lignes, envoyées une fois par tour. L'historique est lui aussi envoyé à chaque tour, et il grossit à chaque tour qui passe.",
      ),
    },
  ...
  },
  {
    ...
    learn: B(
      ...
      'Tu vas appliquer les trois changements qui font vraiment baisser la facture, et ignorer les autres.',
    ),
    act: B('Apply one of these three changes to your target task and measure the difference.',
      'Applique un de ces trois changements à ta tâche cible et mesure la différence.'),
    steps: [
      B('Cut the history: start a new conversation instead of going on to a fiftieth turn.',
        "Coupe l'historique : ouvre une nouvelle conversation au lieu d'aller jusqu'au cinquantième tour."),
      B('Turn off the tools this task does not use.',
        'Désactive les outils dont cette tâche ne se sert pas.'),
      B('Choose the model to fit how hard each task is, not one model for everything.',
        'Choisis le modèle selon la difficulté de chaque tâche, pas un seul modèle pour tout.'),
    ],
    trap: B(
      'Applying all three to a task that runs twice a month. You save nothing and lose an hour.',
      "Appliquer les trois à une tâche qui tourne deux fois par mois. Tu n'économises rien et tu perds une heure.",
    ),
    quiz: {
      ...
      options: [
        ...
        B('The cheap one that runs a thousand times', 'La tâche peu chère qui tourne mille fois'),
      ],
      answer: 2,
      why: B(
        ...
        "Le coût total, c'est le prix multiplié par la fréquence. Une tâche peu chère lancée mille fois coûte souvent plus qu'une tâche chère lancée deux fois. Seule la première mérite une heure de ton temps.",
      ),
    },
  ...
  },
  {
    ...
    master: 'orchestration',
    minutes: 7,
    title: B('Run your agent on your own API key', 'Fais tourner ton agent avec ta propre clé API'),
    learn: B(
      'You will take the agent you built here and run it yourself, outside the platform.',
      "Tu vas récupérer l'agent construit ici et le faire tourner toi-même, en dehors de la plateforme.",
    ),
    act: B('Export your agent and connect it to a framework with your own API key.',
      'Exporte ton agent et branche-le sur un framework avec ta propre clé API.'),
    steps: [
      B('Your agent comes down to two things: your prompt and your tool descriptions. Both are text.',
        'Ton agent tient en deux choses : ton prompt et la description de tes outils. Les deux sont du texte.'),
      B('Before the first run, set a spending cap with your provider.',
        'Avant le premier lancement, fixe un plafond de dépense chez ton provider.'),
      B('Test it once more in read-only mode, on your key, before letting it write anything.',
        'Teste-le encore une fois en lecture seule, avec ta clé, avant de le laisser écrire quoi que ce soit.'),
    ],
    trap: B(
      ...
      "Passer en production sans plafond parce que l'essai a coûté deux centimes. Un agent bloqué dans une boucle peut faire exploser la facture en une nuit.",
    ),
    quiz: {
      q: B('What is the first thing to do before running it on your own key?',
        'Quelle est la première chose à faire avant de le lancer avec ta propre clé ?'),
      options: [
      ...
      why: B(
        ...
        "Tout le reste se corrige le lendemain. Une boucle qui a tourné toute la nuit, non : c'est la seule erreur qui coûte de l'argent, pas seulement du temps.",
      ),
    },
    badge: B('Runs their own agent', 'Fait tourner son propre agent'),
  },
]
...
export const PATH_MODULES: Module[] = [
  {
    ...
    blurb: B('Pick the task you will practise on, and a place to keep what works.',
      "Choisis la tâche sur laquelle tu vas t'entraîner, et un endroit où garder ce qui marche."),
  },
  {
    ...
    blurb: B('Tools are useless if you cannot talk to them. One task per prompt, the right context, a clear format.',
      'Les outils ne servent à rien si tu ne sais pas leur parler. Une tâche par prompt, le bon contexte, un format clair.'),
  },
  {
  ...
  },
  {
    ...
    blurb: B("Time to step up: plan before writing, spot the model's doubts, and know when to start over.",
      'On passe à la vitesse supérieure : faire un plan avant le texte, repérer les doutes du modèle, savoir quand repartir de zéro.'),
  },
  {
  ...
  },
  {
    ...
    blurb: B('Its memory, its projects, and what it really reads in your files.',
      "Sa mémoire, ses projets, et ce qu'il lit vraiment dans tes fichiers."),
  },
  {
    ...
    blurb: B('Compare several documents at once, and edit instead of starting over.',
      "Compare plusieurs documents d'un coup, et modifie au lieu de tout régénérer."),
  },
  {
    ...
    blurb: B('Work where your files already are, and get answers drawn only from your sources.',
      'Travaille là où sont déjà tes fichiers, et obtiens des réponses tirées uniquement de tes sources.'),
  },
  {
  ...
  },
  {
    ...
    blurb: B('What it sees, clear decisions after every meeting, and the access rights behind it all.',
      "Ce qu'il voit, des décisions claires après chaque réunion, et les droits d'accès derrière."),
  },
  {
    ...
    blurb: B('Do not stop at productive, become autonomous: pick the agent type, write its method, allow one action at a time.',
      "Ne te contente pas d'être productif, deviens autonome : choisis le type d'agent, écris sa méthode, autorise une action à la fois."),
  },
  {
    ...
    blurb: B('Judge a screen with rules, describe its structure, build a page that works.',
      'Juge un écran avec des règles, décris sa structure, construis une page qui fonctionne.'),
  },
  {
    ...
    blurb: B('Measure before cutting, cut in the right place, and run your agent on your own key.',
      'Mesure avant de couper, coupe au bon endroit, et fais tourner ton agent avec ta propre clé.'),
  },
]
