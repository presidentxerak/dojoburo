...
const WEEKEND: Pack = {
  ...
  blurb: B('Seven lessons, under an hour, free. Finally speak AI: the words, the limits, the cost.',
    "Sept leçons, moins d'une heure, gratuit. Parle enfin l'IA : les mots, les limites, le coût."),
  glyph: 'peak',
  tint: '#7b5cff',
  kit: 'course',
...
const GENERAL: Pack = {
  ...
  blurb: B('Thirteen dojo cities to finally put AI to work: prompting, the models, the assistants, agents, design, cost.',
    "Treize cités dojo pour enfin faire bosser l'IA pour toi : le prompt, les modèles, les assistants, les agents, le design, le coût."),
  glyph: 'diamond',
  tint: '#0ea5e9',
  kit: 'study',
