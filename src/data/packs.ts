...
const WEEKEND: Pack = {
  id: 'weekend',
  door: 'free',
  title: B('The AI weekend', "Le week-end IA"),
  blurb: B('Seven lessons, under an hour, free. The words, the limits, the cost.',
...
const GENERAL: Pack = {
  ...
  blurb: B('Thirteen dojo cities: prompting, the models, the assistants, agents, design, cost.',
