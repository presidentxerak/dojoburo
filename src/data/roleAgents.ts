...
export const ROLE_AGENTS: RoleAgent[] = [
  ...
  },
  {
    id: 'work',
    name: 'Wade',
    role: 'Agent Travail · livrables',
    cat: 'Travail',
    blurb: 'Exécute à la demande les livrables concrets que ta crème d’agents sait produire.',
    tint: '#1fa563',
    dept: 'Engineering',
  },
  {
    id: 'web',
    name: 'Wren',
    role: 'Agent Web · sites',
    cat: 'Web',
    blurb: 'Génère, déploie et met à jour le site public de ton entreprise.',
    tint: '#2f7fd6',
    dept: 'Product',
  },
  {
    id: 'acq',
    name: 'Mia',
    role: 'Agent Acquisition · Meta',
    cat: 'Acquisition',
    blurb: 'Crée et pilote tes campagnes Meta (Facebook & Instagram) pour attirer des clients.',
    tint: '#e0459b',
    dept: 'Growth',
  },
  {
    id: 'outbound',
    name: 'Sol',
    role: 'Agent Outbound · prospection',
    cat: 'Outbound',
    blurb: 'Trouve des prospects, vérifie les emails et lance des séquences d’approche.',
    tint: '#d98c17',
    dept: 'Growth',
  },
  {
    ...
    cat: 'Mesure',
    blurb: 'Instrumente les métriques et te montre ce que tes agents produisent et consomment.',
    tint: '#0e9b6a',
    dept: 'Engineering',
  },
  {
    id: 'revenue',
    name: 'Fin',
    role: 'Agent Revenu · offres',
    cat: 'Revenus',
    blurb: 'Construit ton offre, tes tarifs et ta page de paiement, puis encaisse tes clients.',
    tint: '#e0483f',
    dept: 'Finance',
  },
  {
