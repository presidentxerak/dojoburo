...
export const CONNECTORS: Connector[] = [
  ...
  {
    id: 'zoom', unwired: true, label: 'Zoom', provider: 'Zoom', category: 'Comms',
  ...
  {
    id: 'jira', unwired: true, label: 'Jira', provider: 'Atlassian', category: 'Dev',
  ...
  {
    id: 'asana', unwired: true, label: 'Asana', provider: 'Asana', category: 'Dev',
  ...
  {
    id: 'airtable', unwired: true, label: 'Airtable', provider: 'Airtable', category: 'Docs & Notes',
  ...
  {
    id: 'shopify', unwired: true, label: 'Shopify', provider: 'Shopify', category: 'CRM & Sales',
  ...
  {
    id: 'figma', unwired: true, label: 'Figma', provider: 'Figma', category: 'Design',
  ...
  {
    id: 'canva', unwired: true, label: 'Canva', provider: 'Canva', category: 'Design',
  ...
  {
    id: 'gclassroom', unwired: true, label: 'Google Classroom', provider: 'Google', category: 'Docs & Notes',
  ...
  {
    id: 'salesforce', unwired: true, label: 'Salesforce', provider: 'Salesforce', category: 'CRM & Sales',
  ...
  {
    id: 'whatsapp', unwired: true, label: 'WhatsApp Business', provider: 'Meta', category: 'Comms',
  ...
  {
    id: 'meta', unwired: true, label: 'Meta Ads', provider: 'Meta', category: 'Marketing & Social',
