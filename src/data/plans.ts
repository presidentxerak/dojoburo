...
export const PLANS: Plan[] = [
  {
    ...
    fr: {
      tagline: `${DISCOVERY_DAYS} jours, une leçon par jour. Ton adresse, rien d'autre.`,
      inclHead: 'Comprend',
      incl: [
        `Les ${DISCOVERY_DAYS} leçons de découverte, en entier`,
        'Un badge par jour, et la carte qui montre où tu en es',
        "Aucune carte bancaire, aucun essai qui se transforme en abonnement",
        "Si ce n'est pas pour toi, tu auras perdu une semaine, rien de plus",
      ],
    },
  },
  {
    ...
    fr: {
      ...
      incl: [
        "Chaque cité dojo, dans l'ordre que tu veux",
        ...
        "Refais n'importe quel niveau, quand tu veux, depuis ton profil",
      ],
    },
  },
  {
    ...
    fr: {
      tagline: 'Une cité de plus, taillée pour le métier que tu fais vraiment.',
      inclHead: 'En supplément de la Formation, par métier',
      incl: [
        'Une cité dojo écrite pour ton métier, pas adaptée après coup',
        'Les cas que tu croises un mardi, pas ceux qui font une belle démo',
