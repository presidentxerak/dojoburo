...
export const DICT = {
  ...
  'ln.essential': { en: "The essentials", fr: "L'essentiel" },
  'ln.concepts': { en: "Key concepts", fr: "Les notions clés" },
  'ln.walk': { en: "Worked example, step by step", fr: "Exemple guidé, pas à pas" },
  ...
  // LE PROFIL À ONGLETS · « ajoute des onglets car elle n'est pas claire du
  // tout ». Cinq onglets, un sujet chacun.
  'pr.tabs': { en: "Profile sections", fr: "Sections du profil" },
  'pr.tabProgress': { en: "Progress", fr: "Progression" },
  'pr.tabBadges': { en: "Badges", fr: "Badges" },
  'pr.tabTrainings': { en: "Trainings", fr: "Formations" },
  'pr.tabAccount': { en: "Account", fr: "Compte" },
  'pr.tabSettings': { en: "Settings", fr: "Paramètres" },
  'pr.yourGrade': { en: "Your grade", fr: "Votre grade" },
  'pr.nextGrade': { en: "{n} more levels to the {belt}", fr: "Encore {n} niveaux avant la {belt}" },
  'pr.nextGrade1': { en: "One more level to the {belt}", fr: "Encore un niveau avant la {belt}" },
  'pr.topGrade': { en: "You hold the highest grade of the dojo.", fr: "Vous détenez le grade le plus élevé du dojo." },
  'pr.gradesH2': { en: "The seven grades", fr: "Les sept grades" },
  'pr.gradesLead': { en: "Your grade comes from your level, and your level from the dojos you actually finished. Nothing is bought.", fr: "Votre grade découle de votre niveau, et votre niveau des dojos que vous avez réellement terminés. Rien ne s'achète." },
  'pr.fromLevel': { en: "From level {n}", fr: "À partir du niveau {n}" },
  'pr.gradeNow': { en: "Your grade", fr: "Votre grade" },
  'pr.gradeDone': { en: "Earned", fr: "Obtenu" },
  'pr.gradeLocked': { en: "To earn", fr: "À obtenir" },
  ...
  'st.soundBody': { en: "Music and sound effects in Dojoburo.", fr: "La musique et les effets sonores de Dojoburo." },
  'st.fx': { en: "Visual effects", fr: "Effets visuels" },
  'st.fxBody': { en: "Particles and a small bounce when you press a button.", fr: "Des particules et un léger rebond lorsque vous appuyez sur un bouton." },
  'st.calm': { en: "Reduce animations", fr: "Réduire les animations" },
  'st.calmBody': { en: "Stops the moving scenes and transitions, for comfort or an older device.", fr: "Arrête les scènes animées et les transitions, pour votre confort ou un appareil plus ancien." },
  'st.systemCalm': { en: "Your device already asks for less motion: effects stay off.", fr: "Votre appareil demande déjà moins de mouvement : les effets restent désactivés." },
  'st.haptics': { en: "Vibrations", fr: "Vibrations" },
  'st.hapticsBody': { en: "A short vibration on touch, on phones that allow it.", fr: "Une brève vibration au toucher, sur les téléphones qui le permettent." },
  'st.on': { en: "On", fr: "Activé" },
  'st.off': { en: "Off", fr: "Désactivé" },
  'st.reset': { en: "Restore default settings", fr: "Rétablir les réglages par défaut" },
  'st.dangerH3': { en: "Erase your data", fr: "Effacer vos données" },
  'st.dangerBody': { en: "Removes from this browser your progress, your badges, your Dojoburo game, your unlocked trainings and your settings. What was synced to your account stays online and comes back when you sign in.", fr: "Supprime de ce navigateur votre progression, vos badges, votre partie de Dojoburo, les formations débloquées et vos réglages. Ce qui a été synchronisé avec votre compte reste en ligne et revient lorsque vous vous connectez." },
