...
export const DICT = {
  ...
  'lp.frGo': { en: 'Open the calculator · put your own numbers in', fr: 'Ouvre le calculateur · avec tes propres chiffres' },
  ...
  'lp.dojoLead': {
    ...
    fr: "Ils dorment parce qu'aucun n'existe encore. Choisis la forme de problème que tu as vraiment et celui-là se réveille, puis tu le construis depuis la page blanche. En dessous, la même salle vue de l'autre côté : ouvre un personnage, lis le brief qui le rend ce qu'il est, change-le et regarde ce qui change.",
  },
  'lp.dojoGo': { en: 'Walk in and pick one', fr: 'Entre et choisis-en un' },
  ...
  'lp.notLead': {
    ...
    fr: "Si tu viens pour qu'on fasse le travail à ta place, tu n'es pas à la bonne adresse, et je préfère que tu le saches tout de suite. Si tu viens apprendre comment ça se fait et ce que ça coûte, commence par la première leçon.",
  },
  ...
  'lp.finalH2': { en: 'Ready to start?', fr: 'Prêt à enfin t\'y mettre ?' },
  'lp.finalGo': { en: 'Pick your agent', fr: 'Choisis ton agent' },
  'lp.finalFoot': { en: 'Free · read in your browser · no account to begin', fr: 'Gratuit · se lit dans ton navigateur · aucun compte pour commencer' },
  ...
  'price.entBody': {
    ...
    fr: "Hébergement chez toi ou exécution locale, SSO SAML et revue de sécurité, un concentrateur MCP dédié avec engagement de service, budgets et plafonds de dépense, connecteurs sur mesure et support dédié. Tout reste sur ta propre infrastructure.",
  },
  ...
  // est passé avant eux.
  'dc.like': { en: 'Think of it as', fr: 'Vois ça comme' },
  'dc.words': { en: 'The words we are going to use', fr: 'Les mots qu\'on va employer' },
  'dc.steps': { en: 'What you actually do', fr: 'Ce que tu fais, concrètement' },
  ...
  'res.lead': {
    ...
    fr: "Un mémo par cours, construit depuis les leçons elles-mêmes au moment où tu le demandes. Rien n'est stocké, donc un mémo ne peut jamais porter une version plus ancienne qu'une leçon de la page.",
  },
  ...
  // ---- le dojo -----------------------------------------------------------
  'bd.which': { en: 'Which agent do you need?', fr: "De quel agent as-tu besoin ?" },
  ...
  'ag.ships': { en: 'things you leave with', fr: 'choses que tu emportes' },
  ...
  'ag.whereLead': {
    ...
    fr: "Un framework ne prendra pas ton fichier tel quel : chacun modélise un agent avec ses propres mots, et le travail consiste à savoir quel morceau devient quoi. En voici trois, pour l'idée.",
  },
  ...
  'ac.order': {
    ...
    fr: "C'est le deuxième cours. Le premier est la construction d'un agent, et rien ici n'a beaucoup de sens tant que tu n'en as pas démonté un.",
  },
  ...
  'ac.curriculumLead': {
    ...
    fr: "Cinq pistes, dans l'ordre. Chacune tient debout toute seule, donc tu peux sauter à ce qu'il te faut, mais si tu débutes, commence en haut et descends.",
  },
  'ac.track': { en: 'Track', fr: 'Piste' },
  'ac.forYouIf': { en: 'For you if:', fr: 'Pour toi si :' },
  'ac.done': { en: 'done', fr: 'faites' },
  'ac.openTrack': { en: 'Open track', fr: 'Ouvrir la piste' },
  'ac.min': { en: 'min', fr: 'min' },
  'ac.outcomesH2': { en: 'What you will be able to do!', fr: 'Ce que tu sauras faire !' },
  ...
  'ac.out1s': {
    ...
    fr: "Ce qu'est un agent, pourquoi une équipe vaut mieux qu'un assistant seul, et où se range vraiment chaque outil qu'on te cite.",
  },
  ...
  'ac.out3': { en: 'Design your own system', fr: 'Dessiner ton propre système' },
  'ac.out3s': {
  ...
  'ac.guideNote': {
    ...
    fr: "Tu cherches les pages de réglage pas à pas d'une application précise, Gmail, Notion, Stripe ? Elles sont dans le",
  },
  ...
  'ac.watch': { en: 'Watch it happen · this loops on its own', fr: 'Regarde faire · ça tourne en boucle tout seul' },
  'ac.check': { en: 'Check yourself', fr: 'Vérifie tes acquis' },
  'ac.right': { en: 'That’s it!', fr: "C'est ça !" },
  'ac.wrong': { en: 'Not quite.', fr: 'Pas tout à fait.' },
  'ac.remember': { en: 'Remember this', fr: 'À retenir' },
  'ac.nowDo': { en: 'Now go and do it:', fr: 'Maintenant, à toi de jouer :' },
  ...
  'fw.gives': { en: 'What it gives you', fr: "Ce qu'il t'apporte" },
  'fw.givesNot': { en: 'What it does not give you', fr: "Ce qu'il ne t'apporte pas" },
  'fw.without': { en: 'You can start without one', fr: "Tu peux commencer sans" },
  'fw.whySoMany': { en: 'Why there are so many', fr: "Pourquoi il y en a autant" },
  'fw.h2connect': { en: 'How to export your agent and connect it', fr: "Comment exporter ton agent et le brancher" },
  'fw.connectLead': {
    en: 'Four moves, and they are the same wherever you take it. Only the names of the boxes change.',
    fr: "Quatre gestes, et ce sont les mêmes où que tu l'emmènes. Seuls les noms des cases changent.",
  },
  'fw.stepWrong': { en: 'Where it goes wrong', fr: 'Où ça rate' },
  'fw.buildFirst': { en: 'Build an agent first, if you have not', fr: "Construis d'abord un agent, si ce n'est pas fait" },
  ...
  'fw.where': { en: 'Where each piece of your agent goes', fr: 'Où va chaque morceau de ton agent' },
  'fw.catches': { en: 'What catches people out', fr: 'Ce qui surprend' },
  'fw.takeWhen': { en: 'Take it when', fr: 'Prends-le quand' },
  'fw.notWhen': { en: 'Do not, when', fr: 'Ne le prends pas quand' },
  ...
  'fw.noCodeA': {
    ...
    fr: "Ces projets bougent vite, et un extrait écrit aujourd'hui a tort dans quelques mois : quelqu'un le copie, ça casse, et il croit avoir mal compris. Je t'enseigne donc la partie qui ne se périme pas, qui est aussi celle qui prend du temps :",
  },
  ...
  'sb.online': { en: 'online · ask me anything about DojoBuro', fr: 'en ligne · pose-moi toutes tes questions sur DojoBuro' },
  'sb.newChat': { en: 'New chat', fr: 'Nouvelle discussion' },
  'sb.watchIt': { en: 'Watch it', fr: 'Voir la visite' },
  'sb.topics': { en: 'Topics', fr: 'Sujets' },
  'sb.placeholder': { en: 'Ask me anything · in your own words', fr: 'Pose ta question · avec tes propres mots' },
  'sb.send': { en: 'Send', fr: 'Envoyer' },
  'sb.foot': {
    en: 'Answers may use AI. Never share keys or passwords here.',
    fr: "Les réponses peuvent venir d'une IA. Ne partage jamais de clés ni de mots de passe ici.",
  },
  'sb.noReach': {
    en: "I couldn't reach my brain just now, but these topics cover most questions. Pick one, or watch a walkthrough on the left.",
    fr: "Je n'ai pas pu joindre mon cerveau à l'instant, mais ces sujets couvrent la plupart des questions. Choisis-en un, ou regarde une visite guidée à gauche.",
  },
  ...
  'mp.pill': { en: 'Your teacher keeps the count', fr: 'Ton prof tient le compte' },
  'mp.h2a': { en: 'Where you are, across the', fr: 'Où tu en es, sur les' },
  'mp.h2b': { en: 'courses', fr: 'cours' },
  'mp.here': { en: 'you are here', fr: 'tu es ici' },
  ...
  'mp.small': {
    ...
    fr: "Ce sont des repères de progression, pas des certificats. Personne ne les vend, personne ne les vérifie, et aucun employeur n'en a entendu parler. Ils existent pour que tu puisses distinguer un cours terminé d'un cours commencé.",
  },

  // ---- le panneau d'apprentissage du profil --------------------------------
  'lrn.pickUp': { en: 'Pick up where you stopped', fr: 'Reprends où tu t\'es arrêté' },
  ...
  'lrn.goBuild': { en: 'Go and build the one this dojo did not cover.', fr: "Va construire celui que ce dojo ne couvrait pas." },
  'lrn.master': { en: 'The master.', fr: 'Le maître.' },
  'lrn.yourBelt': { en: 'Your belt', fr: 'Ta ceinture' },
  'lrn.beltRule': {
  ...
  'lrn.yourCourses': { en: 'Your', fr: 'Tes' },
  'lrn.coursesWord': { en: 'courses', fr: 'cours' },
  'lrn.earnedH': { en: 'What you have earned', fr: 'Ce que tu as obtenu' },
  'lrn.earnedNone': {
    en: 'Nothing yet, and nothing is given for showing up. Finish one step and the first badge is yours.',
    fr: "Rien pour l'instant, et rien ne se donne pour avoir été présent. Termine une étape et le premier insigne est à toi !",
  },
  ...
  'lrn.small': {
    ...
    fr: "agents vivent dans le dojo. Les ceintures, les insignes et les diplômes sont des repères de progression gardés dans ce navigateur. Personne ne les vend, personne ne les vérifie, et aucun employeur n'en a entendu parler : ils existent pour que tu puisses distinguer un cours terminé d'un cours commencé.",
  },
  ...
  'g.mapLead': { en: "Thirteen dojo cities. Cross them in any order you like: a master is waiting for you in each one.", fr: "Treize cités dojo. Traverse-les dans l'ordre que tu veux : un maître t'attend dans chacune." },
  ...
  'g.youDo': { en: "Your mission", fr: "Ta mission" },
  'g.trap': { en: "The trap to dodge", fr: "Le piège à éviter" },
  'g.claim': { en: "Grab the badge", fr: "Prends ton badge" },
  'g.badgeGot': { en: "Badge earned!", fr: "Badge gagné !" },
  'g.cityDone': { en: 'Back to the city', fr: 'Retour à la cité' },
  'g.cityDoneBody': { en: "You finished every dojo in this city. Well played! The map shows it, and you can replay any of them.", fr: "Tu as fini tous les dojos de cette cité. Bien joué ! La carte le montre, et tu peux tous les refaire." },
  'g.replay': { en: "Replay any dojo, whenever you want", fr: "Refais n'importe quel dojo, quand tu veux" },
  ...
  'tf.lead': { en: "Pay once, keep everything. No subscription, no card for the free weekend.", fr: "Tu paies une fois, tu gardes tout. Pas d'abonnement, et pas de carte bancaire pour le week-end gratuit." },
  ...
  'tf.errRate': { en: "Too many attempts in a row. Wait a minute and try again.", fr: "Trop d'essais d'affilée. Attends une minute et réessaie." },
  'tf.errUp': { en: "The payment page could not be reached. Nothing was charged.", fr: "La page de paiement n'a pas répondu. Rien n'a été débité." },
  'tf.startFree': { en: "Start for free", fr: "Démarrer gratuitement" },
  'tf.main': { en: "The whole path", fr: "Le parcours entier" },
  'tf.once': { en: "paid once", fr: "payé une fois" },
  'tf.owned': { en: "Already yours", fr: "Déjà à toi" },
  'tf.buy': { en: "Buy", fr: "Acheter" },
  'tf.going': { en: "Opening the payment page…", fr: "Ouverture du paiement…" },
  'tf.trade': { en: "A trade training", fr: "Une formation métier" },
  'tf.perTrade': { en: "per trade", fr: "par métier" },
  'tf.tradeAfter': { en: "Best taken after the full path: it does not explain the basics again.", fr: "À prendre après la formation complète : elle ne réexplique pas les bases." },
  ...
  'tf.fact2': { en: "The training opens in this browser once the payment is confirmed. Your progress is kept here too.", fr: "La formation s'ouvre dans ce navigateur dès que le paiement est confirmé. Ta progression y est gardée aussi." },
  'tf.fact3': { en: "The first dojo of every city stays free, so you can judge before paying.", fr: "Le premier dojo de chaque cité reste gratuit, pour que tu juges avant de payer." },
  'mc.title': { en: "Welcome in!", fr: "Bienvenue !" },
  'mc.wait': { en: "Checking your payment…", fr: "On vérifie ton paiement…" },
  'mc.waitBody': { en: "It takes a second.", fr: "Ça prend une seconde." },
  'mc.okBody': { en: "Your payment is confirmed. You now have", fr: "Ton paiement est confirmé. Tu as maintenant accès à" },
  'mc.go': { en: "Go to my training", fr: "Aller à ma formation" },
  'mc.noTitle': { en: "Nothing to open here", fr: "Rien à ouvrir ici" },
  'mc.noBody': { en: "This page did not receive a paid order. If you just paid, open the link from your payment confirmation again.", fr: "Cette page n'a pas reçu de commande payée. Si tu viens de payer, rouvre le lien de ta confirmation de paiement." },
  'mc.errBody': { en: "We could not check the payment right now. Try again in a minute: nothing is lost.", fr: "On n'a pas pu vérifier le paiement pour l'instant. Réessaie dans une minute : rien n'est perdu." },
  'ln.steps': { en: "The moves", fr: "Les gestes" },
  'ln.why': { en: "Why it works", fr: "Pourquoi ça marche" },
  'ln.example': { en: "Before and after", fr: "Avant / après" },
  'ln.before': { en: "Before", fr: "Avant" },
  'ln.after': { en: "After", fr: "Après" },
  'ln.exercise': { en: "Your turn", fr: "À toi de jouer" },
  'ln.goal': { en: "What you will have:", fr: "Ce que tu vas obtenir :" },
  'ln.copy': { en: "Copy the prompt", fr: "Copier le prompt" },
  'ln.copied': { en: "Copied", fr: "Copié" },
  'ln.checkH': { en: "Check your result", fr: "Vérifie ton résultat" },
  ...
  'gm.dojosDone': { en: "dojos done", fr: "dojos finis" },
  'gm.xpTitle': { en: "Experience earned across every dojo you finished", fr: "Expérience gagnée sur tous tes dojos terminés" },
  'gm.dojosTitle': { en: "Your dojos", fr: "Tes dojos" },
  'gm.dojosLead': { en: "Pick your training and finally put AI to work. Each one is a set of dojo cities you cross at your own pace.", fr: "Choisis ta formation et fais enfin travailler l'IA pour toi. Chacune est un ensemble de cités dojo que tu traverses à ton rythme." },
  ...
  'gm.start': { en: "Let's go", fr: "C'est parti" },
  'gm.see': { en: "See what is inside", fr: "Voir ce qu'il y a dedans" },
  'gm.backDojos': { en: "Your dojos", fr: "Tes dojos" },
  ...
  'gm.lockTitle': { en: "This training is still locked", fr: "Cette formation est encore fermée" },
  'gm.lockBody': { en: "The first dojo is open so you can judge for yourself. The rest comes with the training, bought once, yours for good.", fr: "Le premier dojo est ouvert pour que tu juges par toi-même. Le reste vient avec la formation, achetée une fois, à toi pour de bon." },
  ...
  'pr.mapBody': { en: "See every dojo city and jump into one.", fr: "Vois toutes les cités dojo et fonce dans l'une d'elles." },
  'pr.ownedH2': { en: "What you unlocked", fr: "Ce que tu as débloqué" },
  'pr.tester': { en: "This address opens every training so you can read them. It is a test pass, not a purchase.", fr: "Cette adresse ouvre toutes les formations pour que tu puisses les lire. C'est un passe d'essai, pas un achat." },
  'pr.dataH2': { en: "Where your progress lives", fr: "Où vit ta progression" },
  'pr.dataBody': { en: "In this browser, and nowhere else. No account, nothing sent. Clear it and you lose what you finished here.", fr: "Dans ce navigateur, et nulle part ailleurs. Aucun compte, rien d'envoyé. Si tu l'effaces, tu perds ce que tu as terminé ici." },
  'pr.forget': { en: 'Erase everything', fr: 'Tout effacer' },
  'pr.opened': { en: 'Open', fr: 'Ouverte' },
  'cm.title': { en: 'The valley', fr: 'La vallée' },
  'cm.lead': { en: "Every dojo city, and where you stand.", fr: "Toutes les cités dojo, et où tu en es." },
  'cm.close': { en: 'Close the map', fr: 'Fermer la carte' },
  /* --- la semaine gratuite ---------------------------------------------- */
  'd.title': { en: "The 7 days of AI!", fr: "Les 7 jours de l'IA !" },
  'd.lead': { en: "One lesson a day, seven minutes each. You finally get the words, the tools and what it really costs.", fr: "Une leçon par jour, sept minutes chacune. Tu maîtrises enfin les mots, les outils et ce que ça coûte vraiment." },
  'd.days': { en: 'days', fr: 'jours' },
  'd.start': { en: "Let's go", fr: "C'est parti" },
  ...
  'd.ask': { en: "Your email opens the week", fr: "Ton adresse ouvre la semaine" },
  'd.place': { en: "you@example.com", fr: "toi@exemple.com" },
  ...
  /* --- le profil ---------------------------------------------------------- */
  'pr.title': { en: "Your progress", fr: "Ta progression" },
  'pr.lead': { en: "What you earned, and where to jump back in.", fr: "Ce que tu as gagné, et où reprendre." },
  'pr.badges': { en: 'badges', fr: 'badges' },
  'pr.ofPath': { en: 'of the path', fr: 'du parcours' },
  'pr.caseH2': { en: "Your trophy case", fr: "Ta vitrine" },
  'pr.citiesH2': { en: "Your cities", fr: "Tes cités" },
  'pr.replay': { en: 'Redo', fr: 'Refaire' },
  'pr.sheet': { en: 'Take-away sheet', fr: 'Fiche à emporter' },

  /* --- ce qui est fermé --------------------------------------------------- */
  'g.lockWeek': { en: "Drop your email to open this", fr: "Donne ton adresse pour ouvrir ça" },
  'g.lockWeekBody': { en: "The seven discovery days are free. One address and they open.", fr: "Les sept jours de découverte sont gratuits. Une adresse, et ils s'ouvrent." },
  ...
  'g.profile': { en: "Your progress", fr: "Ta progression" },

  /* --- les formations métier ---------------------------------------------- */
  'tr.title': { en: "Pick your trade", fr: "Choisis ton métier" },
  'tr.lead': { en: "The same dojo cities, filled with the objects of your job and the mistakes that go with it.", fr: "Les mêmes cités dojo, remplies des objets de ton métier et des erreurs qui vont avec." },
  'tr.needH2': { en: 'It builds on the path', fr: 'Elle prolonge le parcours' },
  'tr.needBody': { en: "A trade course assumes you finished the path. It does not explain context or roles again, which is why it is shorter and cheaper.", fr: "Une formation métier suppose que tu as fait le parcours. Elle ne réexplique ni le contexte ni les rôles, et c'est pour ça qu'elle est plus courte et moins chère." },
  'tr.pick': { en: "Train on this trade", fr: "M'entraîner sur ce métier" },
  'tr.picked': { en: "This is your trade", fr: "C'est ton métier" },
  'tr.toTrade': { en: "Your trade", fr: "Ton métier" },
  ...
  'tr.yours': { en: "Your trade", fr: "Ton métier" },
  'tr.none': { en: 'No trade picked yet', fr: 'Aucun métier choisi' },

  /* --- le site promo ------------------------------------------------------- */
  'lp2.heroGo': { en: "Start the free week", fr: "Démarrer la semaine gratuite" },
  'lp2.whoPill': { en: 'Who it is for', fr: 'À qui c\'est destiné' },
  'lp2.whoH2': { en: "Stuck with AI? Three ways it shows", fr: "Bloqué avec l'IA ? Trois façons de l'être" },
  ...
  'lp2.o1go': { en: "Start now", fr: "Je commence" },
  'lp2.o2': { en: 'The full path', fr: 'Le parcours complet' },
  'lp2.o2b': { en: "Prompting, the models, the five assistants, agents, design and cost. Yours for good, updates included.", fr: "Le prompt, les modèles, les cinq assistants, les agents, le design et le coût. À toi pour de bon, mises à jour comprises." },
  'lp2.o2go': { en: 'See the map', fr: 'Voir la carte' },
  'lp2.o3': { en: "Your trade", fr: "Ton métier" },
  'lp2.o3b': { en: "The objects of your job and the mistakes that go with it. On top of the path, never instead of it.", fr: "Les objets de ton métier et les erreurs qui vont avec. En plus du parcours, jamais à sa place." },
  'lp2.o3go': { en: 'See the trades', fr: 'Voir les métiers' },
  'lp2.trades': { en: 'trades', fr: 'métiers' },
  'lp2.citiesH2': { en: "The whole programme, out in the open", fr: "Le programme entier, à découvert" },
  'lp2.citiesLead': { en: "Every city, every dojo, readable before you pay. The first dojo of each one is open.", fr: "Chaque cité, chaque dojo, lisibles avant de payer. Le premier dojo de chacune est ouvert." },
  'lp2.howPill': { en: 'How it goes', fr: 'Comment ça se passe' },
  'lp2.howH2': { en: "A game, and it is on purpose!", fr: "Un jeu, et c'est fait exprès !" },
  ...
  'lp2.tradesH2': { en: "And then, your own trade", fr: "Et ensuite, ton métier" },
  'lp2.tradesLead': { en: "Same cities, same dojos, same masters. What changes is the matter: your objects, your mistakes.", fr: "Mêmes cités, mêmes dojos, mêmes maîtres. Ce qui change, c'est la matière : tes objets, tes erreurs." },
  'lp2.saidPill': { en: 'What students say', fr: 'Ce que disent les élèves' },
  'lp2.saidH2': { en: "Nothing yet, and I will not invent it", fr: "Rien encore, et je n'inventerai rien" },
  'lp2.saidBody': { en: "This course is new. Rather than write three testimonials nobody gave, this section stays empty until real students have finished. Judge it on the free week instead.", fr: "Cette formation est neuve. Plutôt que d'écrire trois témoignages que personne n'a donnés, cette section reste vide jusqu'à ce que de vrais élèves aient fini. Juge-la sur la semaine gratuite." },
  'lp2.saidGo': { en: "Judge for yourself", fr: "Juge par toi-même" },
