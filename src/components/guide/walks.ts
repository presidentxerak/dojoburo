...
export const WALKS: Record<WalkId, Walk> = {
  ...
  teams: {
    ...
    beats: [
      { id: 'pick', title: '1 · A card is a whole team', body: 'Not a template and not a prompt: a card is a team with a crew attached. Social campaign, mobile app, book, online shop, start-up, pick the one that matches your goal.', fr: { title: "1 · Une carte est une équipe entière", body: "Ni un gabarit ni une consigne : une carte est une équipe avec ses coéquipiers attachés. Campagne sociale, application mobile, livre, boutique en ligne, start-up : prenez celle qui correspond à votre objectif." } },
      { id: 'crew', title: '2 · The crew is listed up front', body: 'Every card names its teammates and what each one does before you pick it, a researcher, a maker, an analyst, a team lead. No surprises after the fact.', fr: { title: "2 · L'équipe est annoncée d'avance", body: "Chaque carte nomme ses coéquipiers et ce que fait chacun avant que vous ne la choisissiez : un chercheur, un fabricant, un analyste, un responsable. Aucune surprise après coup." } },
      { id: 'apps', title: '3 · Their apps come with them', body: 'The apps that job needs are already attached to the right teammate. Connecting one is a click; the card shows you which ones before you choose.', fr: { title: "3 · Leurs applications viennent avec", body: "Les applications dont ce métier a besoin sont déjà rattachées au bon coéquipier. En brancher une tient en un clic ; la carte vous montre lesquelles avant que vous ne choisissiez." } },
      { id: 'budget', title: '4 · You see the budget first', body: 'Each card shows what one full run would cost on a real provider key, so you know the figure before you tick it. Light, Medium or Heavy tells you at a glance how much work it is.', fr: { title: "4 · Vous voyez le budget en premier", body: "Chaque carte montre ce qu'un passage complet coûterait sur une vraie clé de fournisseur, pour que vous connaissiez le chiffre avant de cocher. Léger, Moyen ou Lourd vous dit d'un coup d'oeil la quantité de travail." } },
      { id: 'loop', title: '5 · The plan runs in order', body: 'Every card has a fixed plan of steps. Hit Run every step and the team lead walks it top to bottom, handing each step to the teammate who owns it.', fr: { title: "5 · Le plan se déroule dans l'ordre", body: "Chaque carte a un plan d'étapes fixe. Appuyez sur Lancer toutes les étapes et le responsable le parcourt de haut en bas, confiant chaque étape au coéquipier qui la porte." } },
      { id: 'edit', title: '6 · Nothing is locked', body: 'Rename teammates, add or remove them, change the apps they reach, rewrite how any one of them works. The card is a starting point, not a cage.', fr: { title: "6 · Rien n'est verrouillé", body: "Renommez des coéquipiers, ajoutez-en ou retirez-en, changez les applications qu'ils atteignent, réécrivez la façon de travailler de n'importe lequel. La carte est un point de départ, pas une cage." } },
    ],
  },
  ...
  apps: {
    ...
    beats: [
      ...
      { id: 'cost', title: '5 · What you pay on top', body: 'One monthly plan, paid by card in your own currency. Nothing else is added, no per-app fee, no per-teammate fee, no setup fee. And nothing here is metered, because nothing in the dojo calls a paid model.', fr: { title: "5 · Ce que vous payez en plus", body: "Une formule mensuelle, par carte, dans votre propre monnaie. Rien d'autre ne s'ajoute : aucun frais par application, aucun frais par coéquipier, aucun frais de mise en service. Et rien ici n'est compté, parce que rien dans le dojo n'appelle un modèle payant." } },
      { id: 'sub', title: '6 · Your own apps stay yours', body: 'We never bill you for Notion, Slack, Stripe or anything else you connect. If a plan is needed there, you pay it to them, exactly as you do today.', fr: { title: "6 · Vos propres applications restent les vôtres", body: "Nous ne vous facturons jamais Notion, Slack, Stripe ni rien de ce que vous branchez. Si une formule y est nécessaire, vous la payez chez eux, exactement comme aujourd'hui." } },
      { id: 'byok', title: '7 · Or bring your own key', body: 'The day you take an agent out of the dojo, it runs on your own provider key. Your provider bills you directly, we take nothing per run, and we never sit between you and that bill.', fr: { title: "7 · Ou apportez votre propre clé", body: "Le jour où vous sortez un agent du dojo, il tourne sur votre propre clé de fournisseur. Votre fournisseur vous facture directement, nous ne prenons rien par passage, et nous ne nous mettons jamais entre vous et cette facture." } },
    ],
  },
}
