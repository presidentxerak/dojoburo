// The three.js half of the character preview.
//
// Everything that imports a character now goes through ./Agent3DPreview, which
// mounts this lazily. Keeping the two apart is what stops a job-title page —
// prose, a photo of a role, one small figure at the top — from downloading the
// whole 3D engine before its first paragraph exists.
...
export default function Agent3DScene({
  character,
  size = 120,
  mood = 'happy',
  speed = 1,
